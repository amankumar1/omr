...
static void initializeCodeCache(TR::CodeCacheManager &codeCacheManager) {
  ...
  codeCacheConfig._emitElfObject =
...
// "helpers"
// helpers is an array of pointers to helpers that compiled code needs to
// reference
...
static bool initializeJitBuilder(TR_RuntimeHelper *helperIDs,
                                 void **helperAddresses, int32_t numHelpers,
                                 char *options) {
