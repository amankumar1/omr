...
void HookGen::writeEventToPrivateHeader(const char *name, const char *condition,
  ...
  fprintf(_privateFile, "\t\t(*J9_HOOK_INTERFACE(hookInterface))->"
                        "J9HookDispatch(J9_HOOK_INTERFACE(hookInterface), "
                        "%s%s, &eventData); \\\n",
...
void HookGen::displayUsage() { fprintf(stderr, "hookgen {fileName}\n"); }
