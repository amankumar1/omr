...
TEST(TraceLifecycleTest, moduleLoadBeforeThreadAttach) {
   ...
   * flushes the trace buffers.
   * This succeeds for a weird reason: omr_ras_cleanupTraceEngine() actually
   * deregistered all
   * subscribers when it detached the current thread. This Deregister call does
   * nothing.
   */
  OMRTEST_ASSERT_ERROR_NONE(
