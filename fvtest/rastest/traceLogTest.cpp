...
TEST(TraceLogTest, stressTraceBufferManagement) {
   ...
   * monitors, and it is unsafe
   * to log tracepoints from a omrthread function that manipulates monitor
   * state. In particular, j9thr.17
   * is fired from unblock_spinlock_threads() via
