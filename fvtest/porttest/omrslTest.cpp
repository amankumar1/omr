 ...
 */
  ...
  if (OMRPORT_SL_UNSUPPORTED != rc) {
    outputErrorMessage(PORTTEST_ERROR_ARGS, "Received error code %zu instead "
                                            "of error code %zu for shared "
                                            "library, \n%s,\n",
  ...
  if ((OMRPORT_SL_INVALID != rc) && (OMRPORT_SL_NOT_FOUND != rc)) {
    outputErrorMessage(
        PORTTEST_ERROR_ARGS, "Received error code %zu instead of error code "
                             "%zu or %zu for shared library, \n%s,\n",
        rc, (uintptr_t)OMRPORT_SL_INVALID, (uintptr_t)OMRPORT_SL_NOT_FOUND,
        sharedLibName, omrerror_last_error_message());
    goto exit;
  }
...
TEST(PortSlTest, sl_AixDLLMissingDependency) {
  ...
  if (!isValidLoadErrorMessage(osErrMsg, possibleMessageStrings)) {
    outputErrorMessage(PORTTEST_ERROR_ARGS, " Cannot find valid error code, "
