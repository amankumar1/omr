...
TEST(PortHypervisorTest, DISABLED_HypervisorPresent) {
  ...
  if (!isVirtual) {
    ...
    case J9HYPERVISOR_NOT_PRESENT: {
       ...
       * detected. */
      outputComment(PORTLIB, "\t\tTest Passed: No Hypervisor present and "
    ...
    case J9PORT_ERROR_HYPERVISOR_UNSUPPORTED: {
       ...
       * supported. */
      outputComment(
          PORTLIB, "\t\tThis platform does not support Hypervisor detection\n");
      break;
    }
    ...
    case J9PORT_ERROR_HYPERVISOR_UNSUPPORTED: {
      if (portTestEnv->negative) {
         ...
         * to return
         * error code: J9PORT_ERROR_HYPERVISOR_UNSUPPORTED, when -hypervisor is
         * specified.
         */
         ...
         * indeed
         * detected an unsupported hypervisor (other the ones passed for
         * negative tests).
         */
        OMRTEST_EXPECT_FAILURE(
            "j9hypervisor_hypervisor_present() "
