...
#else  /* defined(LINUX) || defined(OSX) || defined(AIXPPC) &&                 \
          !defined(J9OS_I5) */
static void updateJ9FileStat(struct OMRPortLibrary *portLibrary,
                             J9FileStat *j9statBuf, struct stat *statBuf);
#endif /* defined(LINUX) || defined(OSX) || defined(AIXPPC) &&                 \
          !defined(J9OS_I5) */
 ...
 * that were created by @ref omrfile_startup
 ...
 * the file operations may be created here.  All resources created here should
 * be destroyed
