 ...
 * of the portlibrary.
 * Any resources that were created by @ref omrport_startup_library should be
 * destroyed here.
 *
 ...
 * portlibrary.
 * All resources created here should be destroyed in @ref
 ...
 * the application to override
 * any functions they desire.  In the event @ref omrport_startup_library fails
