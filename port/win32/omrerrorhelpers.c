 ...
 * duplication as formatting of messages
 * from the OS is the only part of error handling that can not be handled in a
 * generic manner.
 *
 ...
 * NULL.  It is possible, however, that the
...
const char *errorMessage(struct OMRPortLibrary *portLibrary,
   ...
   * the LF
   * it is replaced by a space.  Multi-line OS messages are thus one long
