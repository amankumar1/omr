...
uint32_t infoForSignal(struct OMRPortLibrary *portLibrary,
                       J9UnixSignalInfo *info, int32_t index, const char **name,
                       void **value) {
  *name = "";
...
uint32_t infoForFPR(struct OMRPortLibrary *portLibrary, J9UnixSignalInfo *info,
...
uint32_t infoForGPR(struct OMRPortLibrary *portLibrary, J9UnixSignalInfo *info,
                    int32_t index, const char **name, void **value) {
...
uint32_t infoForVR(struct OMRPortLibrary *portLibrary, J9UnixSignalInfo *info,
                   int32_t index, const char **name, void **value) {
...
uint32_t infoForControl(struct OMRPortLibrary *portLibrary,
                        J9UnixSignalInfo *info, int32_t index,
 ...
 * signal corresponding to @ref info
 *
 */
uint32_t infoForModule(struct OMRPortLibrary *portLibrary,
  ...
  *name = "";
   ...
   * Fortunately, in both XPLINK/OSLINK cases, the dsa is stored in
