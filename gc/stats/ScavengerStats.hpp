...
public:
  struct FlipHistory {
    ...
    uintptr_t
        _flipBytes[OBJECT_HEADER_AGE_MAX + 2]; /**< The historical number of
                                                  bytes flipped in each age
                                                  group */
    uintptr_t _tenureBytes[OBJECT_HEADER_AGE_MAX + 2]; /**< The historical
                                                          number of bytes
                                                          tenured in each age
                                                          group */
  };
  ...
  uintptr_t
      _tenureExpandedBytes; /**< Bytes by which the heap expanded in order to
                               complete the collection */
  uintptr_t
      _tenureExpandedCount; /**< The number of times the heap was expanded in
...
public:
   ...
   * scavenger's scaling factor before
   * starting participation in completeScan(). This ensures that the scaling
   * factor is maximal until all gc
