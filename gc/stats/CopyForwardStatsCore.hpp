...
public:
  ...
  uintptr_t
      _copyObjectsEden; /**< Count of objects copied into survivor in Eden (age
                           0) space */
  ...
  uintptr_t _edenSurvivorRegionCount;    /**< Counts the number of Eden regions
                                            ...
                                            copy-forward (only counted globally -
                                            unused in per-thread stats) */
  uintptr_t _nonEdenSurvivorRegionCount; /**< Counts the number of non-Eden
                                            regions allocated (that is, not
                                            tail-fill regions) for survivor
                                            space in this copy-forward (only
                                            counted globally - unused in
                                            per-thread stats) */
  ...
  uintptr_t
      _syncStallCount; /**< The number of times the thread stalled to sync for
                          normal work */
  uintptr_t _abortStallCount; /**< The number of times the thread stalled to
                                 sync for normal work */
  uintptr_t
      _markStallCount; /**< The number of times the thread stalled to sync for
                          normal work */
  uintptr_t
      _irrsStallCount; /**< The number of times the thread stalled to sync for
  ...
  uintptr_t
      _completeStallCount;  /**< The number of times the thread stalled, and
                               waited for all other threads to complete working
                               */
  ...
  uint64_t _abortStallTime; /**< stall time specifically for copy-forward to
                               mark transition */
  uint64_t
      _markStallTime; /**< stall time specifically for mark work following an
                         abort */
  ...
  uint64_t
      _completeStallTime; /**< The time, in hi-res ticks, the thread spent
                             stalled waiting for all other threads to complete
                             working */
  uintptr_t
      _copiedArraysSplit; /**< The number of array chunks (not counting parts
                             smaller than the split size) processed by this
                             thread in copy-forward mode*/
  uintptr_t
      _markedArraysSplit; /**< The number of array chunks (not counting parts
                             smaller than the split size) processed by this
                             thread in mark mode*/
  ...
  uintptr_t _externalCompactBytes; /**< The number of bytes selected for
                                      compaction outside of the copy-forward
                                      scheme. These would have been included in
                                      the copy-forward if there were sufficient
                                      space */
  ...
  uintptr_t _objectsScannedFromWorkPackets; /**< In depth-first copy-forward,
                                               ...
                                               work packet */
  uintptr_t _objectsScannedFromOverflowedRegion; /**< In depth-first
                                                    copy-forward, the number of
                                                    objects scanned by this
                                                    thread which it found in an
                                                    overflowed region (while
                                                    handling work packet
                                                    overflow) */
  uintptr_t
  ...
  uintptr_t
      _objectsScannedFromDepthStack; /**< In depth-first copy-forward, the
                                        number of objects scanned by this thread
                                        which it found on its depth stack (that
                                        is, one it resumed as it was going "up"
                                        the tree) */
  uintptr_t
...
public:
  ...
  MM_CopyForwardStatsCore()
      : _gcCount(UDATA_MAX), _startTime(0), _endTime(0), _freeMemoryBefore(0),
        ...
        _scanCacheOverflow(false), _aborted(false), _edenEvacuateRegionCount(0),
        _nonEdenEvacuateRegionCount(0), _edenSurvivorRegionCount(0),
        _nonEdenSurvivorRegionCount(0)
#if defined(J9MODRON_TGC_PARALLEL_STATISTICS)
        ,
