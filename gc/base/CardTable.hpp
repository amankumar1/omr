...
public:
   ...
   * to be indexed by a shifted heap address, alone.
   * This is calculated by subtracting the shifted address of the first byte of
   * the heap from the base of the card table.
   ...
   * barrier.
   * Mark the card in the card table given the address of an object which
   * contains an updated
