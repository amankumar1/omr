...
public:
  ...
  MM_ScavengerCopyScanRatio copyScanRatio; /* Most recent estimate of ratio of
                                              aggregate slots copied to slots
                                              scanned in completeScan() */
#endif                                     /* OMR_GC_MODRON_SCAVENGER */
  ...
  MM_RememberedSetWorkPackets
      *staccatoRememberedSet; /**< The Staccato remembered set used for the
                                 write barrier */
#endif                        /* OMR_GC_STACCATO */
  ...
  uint32_t
      largeObjectAllocationProfilingSizeClassRatio; /**< ratio of lower and
                                                       ...
                                                       allocation profiling */
  uint32_t largeObjectAllocationProfilingTopK; /**< number of most allocation
                                                  size we want to track/report
                                                  in large object allocation
                                                  profiling */
  ...
  volatile OMR_VMThread *gcExclusiveAccessThreadId; /**< thread token that
  ...
  uintptr_t tlhSurvivorDiscardThreshold; /**< below this size GC (Scavenger)
                                            will discard survivor copy cache
                                            TLH, if alloc not succeeded
  ...
  uintptr_t heapExpansionGCTimeThreshold; /**< max percentage of time spent in
                                             gc before expansion */
  uintptr_t
      heapContractionGCTimeThreshold; /**< min percentage of time spent in gc
                                         before contraction */
  uintptr_t heapExpansionStabilizationCount; /**< GC count required before the
                                                heap is allowed to expand due to
                                                excessvie time after last heap
                                                expansion */
  uintptr_t
      heapContractionStabilizationCount; /**< GC count required before the heap
                                            is allowed to contract due to
                                            excessvie time after last heap
                                            expansion */
  ...
  uintptr_t cacheListSplit; /**< the number of ways to split scanCache lists,
                               set by -XXgc:cacheListLockSplit=, or determined
                               heuristically based on the number of GC threads
                               */
  ...
  bool
      fvtest_tarokVerifyMarkMapClosure; /**< True if the collector should verify
                                           that the new mark map defines a
                                           consistent and closed object graph
  ...
  uintptr_t scvTenureAdaptiveTenureAge; /**< The tenure age to use for the
                                           Adaptive scavenger tenure strategy.
                                           */
  ...
  double scavengerCollectorExpandRatio; /**< the ratio of _avgTenureBytes we use
                                           ...
                                           fails */
  uintptr_t
      scavengerMaximumCollectorExpandSize; /**< the maximum amount by which we
                                              will expand when a
...
#endif                             /* OMR_GC_MODRON_SCAVENGER */
#endif                             /* OMR_GC_MODRON_SCAVENGER || OMR_GC_VLHGC */
  double globalMaximumContraction; /**< maximum percentage of committed global
                                      heap which can contract in one GC cycle
                                      (set through
                                      -Xgc:globalMaximumContraction=) */
  double globalMinimumContraction; /**< minimum percentage of committed global
                                      heap which can contract in one GC cycle
                                      (set through
  ...
  UDATA fvtest_forceConcurrentTLHMarkMapCommitFailure; /**< Force failure at
                                                          Concurrent TLH Mark
                                                          Map commit operation
                                                          */
  UDATA fvtest_forceConcurrentTLHMarkMapCommitFailureCounter; /**< Force failure
                                                                 at Concurrent
                                                                 TLH Mark Map
                                                                 commit
                                                                 operation
  ...
  UDATA fvtest_forceConcurrentTLHMarkMapDecommitFailure; /**< Force failure at
                                                            ...
                                                            Map decommit
                                                            operation */
  UDATA fvtest_forceConcurrentTLHMarkMapDecommitFailureCounter; /**< Force
                                                                   failure at
                                                                   Concurrent
                                                                   TLH Mark Map
                                                                   decommit
  ...
  uintptr_t
      heapTailPadding; /** < Minimum amount of readable space past the end of
                          the heap. See Jazz 31620. */
  ...
  MM_GlobalAllocationManager *globalAllocationManager; /**< Used for attaching
                                                          threads to
                                                          AllocationContexts */
  uintptr_t managedAllocationContextCount; /**< The number of allocation
                                              contexts which will be
                                              instantiated and managed by the
                                              GlobalAllocationManagerRealtime
  ...
  uint32_t distanceToYieldTimeCheck; /**< Number of condYield that can be
                                        skipped before actual checking for
                                        yield, when the quanta time has been
                                        relaxed */
  uintptr_t traceCostToCheckYield;   /**< tracing cost (in number of objects
                                        marked and pointers scanned) after we try
                                        to yield */
  uintptr_t sweepCostToCheckYield;   /**< weighted count of free chunks/marked
                                        objects before we check yield in sweep
                                        small loop */
  uintptr_t
  ...
  uintptr_t debug;
  uintptr_t
      allocationTrackerMaxTotalError; /**< The total maximum desired error for
                                         the free bytes approximation, the
                                         larger the number, the lower the
                                         contention and vice versa */
  uintptr_t allocationTrackerMaxThreshold;   /**< The maximum threshold for a
                                                single allocation tracker */
  uintptr_t allocationTrackerFlushThreshold; /**< The flush threshold to be used
                                                for all allocation trackers,
                                                this value is adjusted every
                                                time a new thread is
                                                created/destroyed */
  ...
  MM_ConfigurationOptions configurationOptions; /**< holds the options struct,
                                                   used during startup for
  ...
  bool shouldAllowShiftingCompression; /**< temporary option to enable
                                          ...
                                          shifting pointers */
  bool
      shouldForceSpecifiedShiftingCompression; /**< temporary option to enable
  ...
  bool numaForced; /**< if true, specifies if numa is disabled or enabled
                      (actual value stored in NUMA Manager) by command line
                      option */
  ...
  uintptr_t tarokGlobalMarkIncrementTimeMillis; /**< The time period in
                                                   ...
                                                   (as set by the user, normally
                                                   dynamic)*/
  uintptr_t fvtest_tarokForceNUMANode; /**< The NUMA node to force the heap onto
                                          (UDATA_MAX => no force, 0 =>
                                          interleaved, >0 => specific node) */
  uintptr_t fvtest_tarokFirstContext;  /**< The allocation context number to use
                                          first, when associating the first
  ...
  uintptr_t tarokRememberedSetCardListSize; /* The average (allocated) size in
                                               entries of RememberedSetCardList
                                               per region */
  ...
  uintptr_t
      tarokRegionMaxAge; /**< Maximum age a region can be before it will no
                            ...
                            (saturating age) */
  uintptr_t tarokKickoffHeadroomRegionCount; /**< Count of extra regions
                                                reserved for survivor set, in
                                                case of sudden changes of
                                                survivor rate. Used in
                                                calculation to predict GMP
                                                kickoff */
  MM_RememberedSetCardBucket *rememberedSetCardBucketPool; /* GC thread local
                                                              pools of RS Card
                                                              Buckets for each
                                                              Region (its Card
                                                              List) */
  ...
  uintptr_t tarokDynamicCollectionSetSelectionAbsoluteBudget; /**< Number of
                                                                 budgeted
                                                                 regions to
                                                                 dynamically
                                                                 select for PGC
                                                                 ...
                                                                 required
                                                                 nursery set) */
  double tarokDynamicCollectionSetSelectionPercentageBudget;  /**< Percentage
                                                                 increase of
                                                                 nursery region
                                                                 count to use as
                                                                 dynamically
  ...
  double tarokDefragmentEmptinessThreshold; /**< Emptiness
                                               (freeAndDarkMatter/regionSize)
                                               for a region to be considered as
                                               a target for defragmentation
                                               (used for stable region detection
                                               and region de-fragmentation
                                               selection) */
  ...
  MM_SweepPoolManagerAddressOrderedList
      *sweepPoolManagerAddressOrderedList; /**< Pointer to Sweep Pool Manager
                                              for MPAOL, used for LOA and
                                              nursery */
  ...
  bool
      _holdRandomThreadBeforeHandlingWorkUnit; /**< Whether we should randomly
                                                  hold up a thread entering
                                                  MM_ParallelTask::handleNextWorkUnit()
                                                  */
  uintptr_t
      _holdRandomThreadBeforeHandlingWorkUnitPeriod; /** < How often (in terms
                                                        of number of times
                                                        MM_ParallelTask::handleNextWorkUnit()
  ...
  uintptr_t _forceRandomBackoutsAfterScanPeriod; /**< How often (in terms of
                                                    number of times
                                                    MM_Scavenger::completeScan()
...
private:
   ...
   * Library (known by OS)
   * Note: The only OS supported flags is ZOS however all other platforms have
   * flags array filled by OMRPORT_VMEM_PAGE_FLAG_NOT_USED values
...
public:
  ...
  MMINLINE void setGlobalCollector(MM_Collector *collector) {
  ...
  virtual void setTenureAddressRange(void *base, uintptr_t size) {
     ...
     * removeTenureRange() once
     * heapBaseForBarrierRange0 heapSizeForBarrierRange0 can be removed from
     * J9VMThread
     *
  ...
  MM_GCExtensionsBase()
      : MM_BaseVirtual()
...
#endif /* OMR_GC_MODRON_SCAVENGER */
        ,
        _omrVM(NULL), _globalCollector(NULL)
#if defined(OMR_GC_OBJECT_MAP)
        ,
        _objectMap(NULL)
#endif /* defined(OMR_GC_OBJECT_MAP) */
...
#endif /* OMR_GC_MODRON_SCAVENGER */
        ,
        environments(NULL), largePageWarnOnError(false),
        largePageFailOnError(false), largePageFailedToSatisfy(false),
        requestedPageSize(0),
        ...
        bytesAllocatedMost(0), vmThreadAllocatedMost(NULL),
        splitFreeListSplitAmount(0), enableHybridMemoryPool(false),
        ...
        ,
        debugLOAResize(false), debugLOAFreelist(false), debugLOAAllocate(false)
#endif /* OMR_GC_LARGE_OBJECT_AREA */
        ,
        ...
        parSweepChunkSize(0), markingStackSize(4096),
        ...
        scvTenureStrategySurvivalThreshold(0.99), scvTenureStrategyFixed(false),
        scvTenureStrategyAdaptive(true), scvTenureStrategyLookback(true),
        scvTenureStrategyHistory(true), scavengerEnabled(false)
#if defined(OMR_GC_CONCURRENT_SCAVENGER)
        ,
        ...
        ,
        globalMinimumContraction(
            0.01) /* by default, contract must be at least 1% of the committed
                     heap */
        ,
        ...
        excessiveGCFreeSizeRatio((float)0.03), heapRegionManager(NULL),
        memoryManager(NULL)
#if defined(OMR_GC_MODRON_COMPACTION)
        ,
        compactOnGlobalGC(
            0) /* By default we will only compact on triggers, no forced
                  compactions */
        ,
        ...
        ,
        concurrentBackground(0) /* TODO: remove this workaround once pthread
                                   library on z/linux fixed. see CMVC 94776 */
#else
        ,
        concurrentBackground(1)
#endif /* LINUX && S390 */
        ,
        concurrentSlack(0), cardCleanPass2Boost(2), cardCleaningPasses(2)
#endif /* OMR_GC_MODRON_CONCURRENT_MARK */
        ,
        lowMinimum(0), allowMergedSpaces(1)
#if defined(J9_GC_OBJECT_HEAP_TAIL_PADDING)
        ,
        heapTailPadding(J9_GC_OBJECT_HEAP_TAIL_PADDING) /* Minimum amount of
                                                           readable space past
                                                           the end of the heap.
                                                           See Jazz 31620. */
        ...
        ,
        synchronousGCOnOOM(true), extraYield(false), fixHeapForWalk(false),
        overflowCacheCount(0) /**< initial value of 0.  This is set in
                                 workpackets initialization or via the
                                 commandline */
        ...
        ,
        sweepCostToCheckYield(500) /* weighted count of free chunks/marked
                                      objects before we check yield in sweep
                                      small loop */
        ,
        ...
        nonDeterministicSweep(false), verboseGCManager(NULL),
        verbosegcCycleTime(
        ...
        ,
        heapCeiling(
            LOW_MEMORY_HEAP_CEILING) /* By default, compressed pointers builds
                                        run in the low 32GiB */
#else
        ,
        ...
        ,
        suballocatorCommitSize(SUBALLOCATOR_COMMIT_SIZE) /* default for J9Heap
                                                            suballocator commit
                                                            size is 50 MB */
        ,
...
#if defined(OMR_GC_VLHGC)
        ,
        tarokDebugEnabled(false) /* by default, we turn off the Tarok debug
                                    options since they are an appreciable
                                    performance hit */
        ,
        ...
        tarokKickoffHeadroomRegionCount(0), rememberedSetCardBucketPool(NULL),
        ...
        tarokUseDepthFirstCopyForward(false), tarokMaximumAgeInBytes(0),
