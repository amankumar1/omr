...
protected:
  ...
  bool _chunkedArray;
  omrarrayptr_t
      _spine; /**< field to store the arraylet spine allocated during an
                 arraylet allocation */
...
public:
   ...
   * name suggests to allocate from non zero TLH).
   * We internally, decide which TLH this gets allocated from (depending if its
   * dual TLH mode or not), and whether we clear it or not */
   ...
   * as a root and will be updated if the spine moves.
   ...
   * stored for safe marking and update.
