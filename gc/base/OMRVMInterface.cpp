...
void GC_OMRVMInterface::initializeExtensions(MM_GCExtensionsBase *extensions) {
  ...
  (*mmPrivateHooks)
      ->J9HookRegister(mmPrivateHooks, J9HOOK_MM_PRIVATE_WALK_HEAP_START,
                       hookWalkHeapStart, NULL);
  (*mmPrivateHooks)
      ->J9HookRegister(mmPrivateHooks, J9HOOK_MM_PRIVATE_WALK_HEAP_END,
                       hookWalkHeapEnd, NULL);
}
