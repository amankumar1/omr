...
public:
  virtual MM_ConfigurationLanguageInterface *
  createConfigurationLanguageInterface(MM_EnvironmentBase *env) = 0;
  virtual MM_Configuration *
  createConfiguration(MM_EnvironmentBase *env,
                      MM_ConfigurationLanguageInterface *cli);
