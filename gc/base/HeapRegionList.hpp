 ...
 * cannonical
 * Region for a range of Regions.  A particular RegionList instance will only
 * contain one
 ...
 * operations.
 * RegionQueue supports queue operations (FIFO insertion/deletion via
 * enqueue/dequeue).
 * FreeRegionList supports stack operations (LIFO insertion/deletion via
 * push/pop) plus
