...
private:
  ...
  const bool
      _zeroTLH; /**< if true this TLH is primary (might be cleared by
                   batchClearTLH), if false this is secondary TLH (and it would
                   not be cleared ever) */
...
private:
   ...
   * which toggles
   * enable/disable of TLH. If TLH is disabled, realHeapAlloc holds the true TLH
   * alloc ptr.
   */
