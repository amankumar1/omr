...
public:
   ...
   * during this phase.
   *  On return, all live objects will be marked, although some unreachable
   * objects (such as finalizable
  ...
  scanObject(MM_EnvironmentBase *env, omrobjectptr_t objectPtr,
    ...
    uintptr_t sizeScanned =
        _cli->markingScheme_scanObject(env, objectPtr, reason);
    /* Due to concurrent marking and packet overflow _bytesScanned may be much
     * larger than the total live set
  ...
  MMINLINE uintptr_t scanObjectWithSize(
    ...
    uintptr_t sizeScanned = _cli->markingScheme_scanObjectWithSize(
        env, objectPtr, reason, sizeToDo);
    /* Due to concurrent marking and packet overflow _bytesScanned may be much
     * larger than the total live set
     * because objects may be scanned multiple times.
     */
  ...
  MM_MarkingScheme(MM_EnvironmentBase *env)
      : MM_BaseVirtual(), _omrVM(env->getOmrVM()),
        ...
        _cli(_extensions->collectorLanguageInterface), _markMap(NULL),
