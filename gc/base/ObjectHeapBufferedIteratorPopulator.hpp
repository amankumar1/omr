 ...
 * ObjectHeapBufferedIterators.
 * Instances of subclasses of this class are all singletons and should have no
 * state.
 * Instances of subclasses of this class may be instantiated in debugger
 * extensions to iterate over out of process regions.
 */
...
public:
   ...
   * The receiver may store any necessary information in the state. The state
   * will not be modified by the
   * iterator -- it is reserved for use by the
   * ObjectHeapBufferedIteratorPopulator.
   *
