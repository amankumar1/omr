...
void MM_SweepPoolManagerAddressOrderedListBase::connectChunk(
   ...
   * have to be associated to the pool for the
...
/* Free list candidate has been found - attach it to the free list */
   ...
   * trailing free candidate.  This scenario can occur if a leading
   * free entry is pushed back from a projection from the previous sweep chunk.
   * A leading free candidate that spans the entire chunk in this
