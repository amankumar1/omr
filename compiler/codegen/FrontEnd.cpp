...
void TR_FrontEnd::acquireLogMonitor() { notImplemented("acquireLogMonitor"); }

void TR_FrontEnd::releaseLogMonitor() { notImplemented("releaseLogMonitor"); }
...
uint8_t *TR_FrontEnd::allocateCodeMemory(TR::Compilation *,
                                         uint32_t warmCodeSize,
...
void TR_FrontEnd::resizeCodeMemory(TR::Compilation *, uint8_t *,
                                   uint32_t numBytes) {
  notImplemented("resizeCodeMemory");
}

void TR_FrontEnd::outOfMemory(TR::Compilation *, const char *) {
...
uint8_t *TR_FrontEnd::getCodeCacheTop(TR::CodeCache *codeCache) {
  return (uint8_t *)(~0);
}

void TR_FrontEnd::releaseCodeMemory(void *, uint8_t) {
...
bool TR_FrontEnd::isMethodEnterTracingEnabled(TR_OpaqueMethodBlock *method) {
  return false;
}

bool TR_FrontEnd::isMethodExitTracingEnabled(TR_OpaqueMethodBlock *method) {
  return false;
}
...
uintptrj_t TR_FrontEnd::getObjectHeaderSizeInBytes() {
  notImplemented("getObjectHeaderSizeInBytes");
  return 0;
}
uintptrj_t TR_FrontEnd::getOffsetOfContiguousArraySizeField() {
  notImplemented("getOffsetOfContiguousArraySizeField");
  return 0;
}
uintptrj_t TR_FrontEnd::getOffsetOfDiscontiguousArraySizeField() {
  notImplemented("getOffsetOfDiscontiguousArraySizeField");
  return 0;
}

uintptrj_t TR_FrontEnd::getOffsetOfIndexableSizeField() {
  notImplemented("getOffsetOfIndexableSizeField");
  return 0;
}
...
TR_OpaqueMethodBlock *
TR_FrontEnd::getMethodFromName(char *className, char *methodName,
                               char *signature,
                               TR_OpaqueMethodBlock *callingMethod) {
  notImplemented("getMethodFromName");
  return 0;
}

uint8_t *TR_FrontEnd::getMethodStartPC(TR_OpaqueMethodBlock *method) {
...
bool TR_FrontEnd::isCompiledMethod(TR_OpaqueMethodBlock *method) {
  return false;
}
...
TR_OpaqueClassBlock *TR_FrontEnd::getClassFromStatic(void *p) {
...
int32_t TR_FrontEnd::getStringLength(uintptrj_t objectPointer) {
...
TR::CodeCache *TR_FrontEnd::getDesignatedCodeCache(TR::Compilation *comp) {
  notImplemented("getDesignatedCodeCache");
  return 0;
}

void TR_FrontEnd::setHasFailedCodeCacheAllocation() {
...
intptrj_t TR_FrontEnd::indexedTrampolineLookup(int32_t helperIndex,
                                               void *callSite) {
  notImplemented("indexedTrampolineLookup");
  return 0;
}

bool TR_FrontEnd::needsMethodTrampolines() {
  notImplemented("needsMethodTrampolines");
  return 0;
}

void TR_FrontEnd::reserveNTrampolines(TR::Compilation *, int32_t n,
                                      bool inBinaryEncoding) {
  notImplemented("reserveNTrampolines");
}

bool TR_FrontEnd::hasBackwardBranches(TR_OpaqueMethodBlock *method) {
