 ...
 * in
 * postconditions on the end-of-control-flow label in order for the local
 * register
 ...
 * terrible
 *    effect on the tree evaluator code. Often, the logic for a particular
 * evaluator
 ...
 * outside an internal control flow region (where you’d just use
 * allocateRegister
