...
uint8_t OMR::Machine::getNumberOfGPRs() {
  return self()->getNumberOfRegisters(TR_GPR);
}

uint8_t OMR::Machine::getNumberOfFPRs() {
  return self()->getNumberOfRegisters(TR_FPR);
}

uint8_t OMR::Machine::setNumberOfGPRs(uint8_t numIntRegs) {
  return self()->setNumberOfRegisters(TR_GPR, numIntRegs);
}

uint8_t OMR::Machine::setNumberOfFPRs(uint8_t numFPRegs) {
