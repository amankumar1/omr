...
OMR::Register::Register(uint32_t f)
    : _flags(f), _backingStorage(NULL), _pinningArrayPointer(NULL),
      _assignedRegister(NULL), _colouredRegister(NULL), _siblingRegister(NULL),
      _startOfRange(NULL), _endOfRange(NULL), _startOfRangeNode(NULL),
      _totalUseCount(0), _futureUseCount(0), _outOfLineUseCount(0),
      _association(0), _kind(TR_GPR), _index(0), _cc(NULL) {}
...
OMR::Register::Register(TR_RegisterKinds rk)
    : _flags(0), _backingStorage(NULL), _pinningArrayPointer(NULL),
      ...
      _startOfRange(NULL), _endOfRange(NULL), _startOfRangeNode(NULL),
      _totalUseCount(0), _futureUseCount(0), _outOfLineUseCount(0),
      _association(0), _kind(rk), _index(0), _cc(NULL) {}
...
OMR::Register::Register(TR_RegisterKinds rk, uint16_t ar)
    : _flags(0), _backingStorage(NULL), _pinningArrayPointer(NULL),
      ...
      _startOfRange(NULL), _endOfRange(NULL), _startOfRangeNode(NULL),
      _totalUseCount(0), _futureUseCount(0), _outOfLineUseCount(0),
      _association(ar), _kind(rk), _index(0), _cc(NULL) {}
