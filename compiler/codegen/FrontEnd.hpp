...
public:
  ...
  getMethodFromName(char *className, char *methodName, char *signature,
                    TR_OpaqueMethodBlock *callingMethod = 0);
  ...
  virtual size_t findOrCreateLiteral(TR::Compilation *comp, void *value,
                                     size_t len) {
  ...
  // to J9
  virtual uintptrj_t
  getClassDepthAndFlagsValue(TR_OpaqueClassBlock *classPointer);
  ...
  virtual uint8_t *allocateCodeMemory(TR::Compilation *, uint32_t warmCodeSize,
                                      uint32_t coldCodeSize, uint8_t **coldCode,
                                      bool isMethodHeaderNeeded = true);
  virtual void resizeCodeMemory(TR::Compilation *, uint8_t *,
                                uint32_t numBytes);
  ...
  virtual void reserveNTrampolines(TR::Compilation *, int32_t n,
                                   bool inBinaryEncoding);
