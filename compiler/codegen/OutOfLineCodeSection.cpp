...
void TR_OutOfLineCodeSection::preEvaluatePersistentHelperArguments() {
  TR_ASSERT(_callNode, "preEvaluatePersistentHelperArguments can only be "
                       "called for TR_OutOfLineCodeSection which are helper "
                       "calls");
  TR::TreeEvaluator::initializeStrictlyFutureUseCounts(
      _callNode, TR::comp()->incVisitCount(), _cg);
