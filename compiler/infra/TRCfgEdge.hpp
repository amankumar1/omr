...
public:
  ...
  bool mustRestoreVMThreadRegister() {
    return _flags.testAny(_mustRestoreVMThreadRegister);
  }
  void setMustRestoreVMThreadRegister(bool b) {
    _flags.set(_mustRestoreVMThreadRegister, b);
  }
