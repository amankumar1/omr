...
//
  ...
  public:
    ...
    virtual void free(ValueConstraint *vc) { _vp->freeValueConstraint(vc); }
  ...
  public:
    ...
    void free(ValueConstraint *vc) { _vp->freeValueConstraint(vc); }
  ...
  static TR::CFGEdge *findOutEdge(TR::list<TR::CFGEdge *> &edges,
                                  TR::CFGNode *target);
  ...
  void replacePackedArrayLoad(TR::Node *loadNode, TR::Node *packedNode,
                              TR::Node *curNode, vcount_t visitCount);
  ...
  struct VPStringCached {
    ...
    VPStringCached(TR::TreeTop *append1, TR::TreeTop *append2,
                   TR::Node *appendString1, TR::Node *appendString2,
                   TR::TreeTop *newTree, TR::TreeTop *toStringTree)
        : _treetop1(append1), _treetop2(append2),
          _appendedString1(appendString1), _appendedString2(appendString2),
          _newTree(newTree), _toStringTree(toStringTree) {}
    TR::TreeTop *_treetop1;
    TR::TreeTop *_treetop2;
  ...
  struct TR_PackedArrayLoad {
    ...
    TR_PackedArrayLoad(TR::TreeTop *loadTT, TR::Node *loadNode,
                       TR::Node *clazzPointer, TR::Node *packedDS)
        : _loadTT(loadTT), _loadNode(loadNode), _clazzPointer(clazzPointer),
          _packedDS(packedDS) {}
  ...
  struct InductionVariable : public TR_Link<InductionVariable> {
    InductionVariable(TR::Symbol *sym, TR::Node *entryDef, int32_t incrVN,
                      TR::VPConstraint *incr, TR::ValuePropagation *vp)
  ...
  struct CallInfo : public TR_Link<CallInfo> {
    CallInfo(TR::ValuePropagation *vp, TR_OpaqueClassBlock *thisType,
  ...
  struct VirtualGuardInfo : public TR_Link<VirtualGuardInfo> {
    VirtualGuardInfo(TR::ValuePropagation *vp, TR_VirtualGuard *vgOld,
                     TR_VirtualGuard *vgNew, TR::Node *newGNode, TR::Node *cn)
        : _currentTree(vp->_curTree), _block(vp->_curBlock),
          _oldVirtualGuard(vgOld), _newVirtualGuard(vgNew),
          _newGuardNode(newGNode), _callNode(cn) {}
