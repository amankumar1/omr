...
TR::ValuePropagation::Relationship *
TR::ValuePropagation::createRelationship(int32_t relative,
...
TR::ValuePropagation::StoreRelationship *
TR::ValuePropagation::createStoreRelationship(TR::Symbol *symbol,
...
void TR::ValuePropagation::freeStoreRelationships(
...
void TR::ValuePropagation::freeValueConstraints(
    ValueConstraints &valueConstraints) {
  _vcHandler.empty(valueConstraints);
}

TR::ValuePropagation::ValueConstraint *
TR::ValuePropagation::copyValueConstraints(ValueConstraints &valueConstraints) {
  return _vcHandler.copyAll(valueConstraints);
}

void TR::ValuePropagation::addConstraint(TR::VPConstraint *constraint,
                                         int32_t hash) {
...
TR::ValuePropagation::LoopDefsHashTableEntry *
TR::ValuePropagation::findLoopDef(TR::Node *node) {
...
bool TR::ValuePropagation::propagateConstraint(
...
//
TR::VPConstraint *TR::ValuePropagation::addConstraintToList(
...
// commented for now.
  ...
  if (newOrChanged) {
    if (trace() && node) {
      traceMsg(comp(), "   n%in %s gets new constraint:",
               node->getGlobalIndex(), node->getOpCode().getName());
      rel->print(this, valueNumber, 1);
      traceMsg(comp(), "type of constraint - longConstraint: %p, "
                       "intConstraint: %p, shortConstraint: %p\n",
...
TR::VPConstraint *TR::ValuePropagation::addGlobalConstraint(
...
TR::VPConstraint *
TR::ValuePropagation::addGlobalConstraint(TR::Node *node, int32_t valueNumber,
                                          TR::VPConstraint *constraint,
                                          int32_t relative) {
  ...
  // when an aggregate symbol is
  // referenced in one place on an oload and another as an iload. MG: Update
  // assert?
...
TR::VPConstraint *TR::ValuePropagation::addEdgeConstraint(
...
TR::VPConstraint *
TR::ValuePropagation::addBlockConstraint(TR::Node *node,
                                         TR::VPConstraint *constraint,
...
TR::VPConstraint *TR::ValuePropagation::addBlockOrGlobalConstraint(
...
void TR::ValuePropagation::mergeRelationships(
...
void TR::ValuePropagation::mergeStoreRelationships(ValueConstraint *fromvc,
...
void TR::ValuePropagation::mergeValueConstraints(ValueConstraint *fromvc,
                                                 ValueConstraint *tovc,
                                                 bool preserveFrom) {
...
void TR::ValuePropagation::mergeEdgeConstraints(EdgeConstraints *fromEdge,
...
void TR::ValuePropagation::mergeConstraintIntoEdge(ValueConstraint *constraint,
...
//
TR::ValuePropagation::GlobalConstraint *
TR::ValuePropagation::GlobalConstraint::create(TR::Compilation *c,
                                               int32_t valueNumber) {
...
//
inline uint32_t
TR::ValuePropagation::hashGlobalConstraint(int32_t valueNumber) {
  return valueNumber & _globalConstraintsHTMaxBucketIndex; // exploiting the
                                                           // fact that size is
                                                           // power of two
}
...
//
TR::ValuePropagation::GlobalConstraint *
TR::ValuePropagation::findGlobalConstraint(int32_t valueNumber) {
  if (!_isGlobalPropagation)
    return NULL;
...
//
TR::ValuePropagation::GlobalConstraint *
TR::ValuePropagation::createGlobalConstraint(int32_t valueNumber) {
  uint32_t hash = hashGlobalConstraint(valueNumber);
...
//
TR::ValuePropagation::EdgeConstraints *
TR::ValuePropagation::EdgeConstraints::create(TR::Compilation *c,
                                              TR::CFGEdge *edge) {
...
//
TR::ValuePropagation::EdgeConstraints *
TR::ValuePropagation::getEdgeConstraints(TR::CFGEdge *edge) {
...
TR::ValuePropagation::EdgeConstraints *
TR::ValuePropagation::createEdgeConstraints(TR::CFGEdge *edge,
                                            bool keepBlockList) {
  if (!_isGlobalPropagation)
    return NULL;
...
void TR::ValuePropagation::createExceptionEdgeConstraints(
...
void TR::ValuePropagation::removeConstraint(int32_t valueNumber,
                                            ValueConstraints &valueConstraints,
                                            int32_t relative) {
...
TR::ValuePropagation::StoreRelationship *
TR::ValuePropagation::findStoreRelationship(
...
TR::ValuePropagation::Relationship *
TR::ValuePropagation::findConstraintInList(TR_LinkHead<Relationship> &list,
                                           int32_t relative) {
...
TR::ValuePropagation::Relationship *TR::ValuePropagation::findValueConstraint(
...
TR::ValuePropagation::Relationship *
TR::ValuePropagation::findConstraint(int32_t valueNumber, int32_t relative) {
  return findValueConstraint(valueNumber, _curConstraints, relative);
}

TR::ValuePropagation::Relationship *TR::ValuePropagation::findEdgeConstraint(
...
TR::ValuePropagation::StoreRelationship *
TR::ValuePropagation::findStoreValueConstraint(
...
TR::ValuePropagation::StoreRelationship *
TR::ValuePropagation::findStoreConstraint(int32_t valueNumber,
                                          TR::Symbol *symbol) {
  return findStoreValueConstraint(valueNumber, symbol, _curConstraints);
}

TR::ValuePropagation::StoreRelationship *
TR::ValuePropagation::findStoreEdgeConstraint(int32_t valueNumber,
                                              TR::Symbol *symbol,
                                              EdgeConstraints *edge) {
...
TR::VPConstraint *TR::ValuePropagation::applyGlobalConstraints(
...
TR::VPConstraint *TR::ValuePropagation::getStoreConstraint(TR::Node *node,
                                                           TR::Node *relative) {
...
bool TR::ValuePropagation::hasBeenStored(int32_t valueNumber,
                                         TR::Symbol *symbol,
                                         ValueConstraints &valueConstraints) {
...
void TR::ValuePropagation::checkTypeRelationship(TR::VPConstraint *lhs,
                                                 TR::VPConstraint *rhs,
                                                 int32_t &value,
                                                 bool isInstanceOf,
                                                 bool isCheckCast) {
...
void TR::ValuePropagation::invalidateParmConstraintsIfNeeded(
  ...
  if (symRef && symRef->getSymbol()->getParmSymbol()) {
    ...
    if (parmConstraint) {
      ...
      {
        if (trace())
          traceMsg(comp(), "   Store node %p to parm %d is not compatible with "
                           "rhs, invalidating _parms entry %p\n",
...
TR::VPConstraint *TR::ValuePropagation::mergeDefConstraints(TR::Node *node,
                                                            int32_t relative,
                                                            bool &isGlobal,
                                                            bool forceMerge) {
  ...
  for (cursor.SetToFirstOne(); cursor.Valid(); cursor.SetToNextOne()) {
    ...
    if (defIndex < _useDefInfo->getFirstRealDefIndex()) {
      ...
      if (defNode->getOpCode().isStore()) {
        ...
        // byte(s) are written to
        // and taking the rhs and applying it properly to get the correct value
        // for (potentially wider) datatype
        // of the use
        //
    ...
    if (!hasBeenStored(defValueNumber, sym, _curConstraints)) {
      ...
      for (loopInfo = _loopInfo; loopInfo && loopInfo != container;
        ...
        if (!loopInfo || !loopInfo->_backEdgeConstraints ||
            !hasBeenStored(defValueNumber, sym,
...
void TR::ValuePropagation::replaceByConstant(TR::Node *node,
                                             TR::VPConstraint *constraint,
                                             bool isGlobal) {
  if (isGlobal)
...
TR::Node *TR::ValuePropagation::findThrowInBlock(TR::Block *block,
                                                 TR::TreeTop *&treeTop) {
    ...
    if (defs.IsZero())
      ...
      for (cursor.SetToFirstOne(); cursor.Valid(); cursor.SetToNextOne()) {
        ...
        if (defIndex < _useDefInfo->getFirstRealDefIndex()) {
          ...
          isInductionVariable = false;
          if (trace())
            traceMsg(comp(), "      ivInfo is invalid for sym [%p] as method "
                             "entry is def point\n",
                     sym);
          break;
        }
      ...
      for (cursor.SetToFirstOne(); cursor.Valid(); cursor.SetToNextOne()) {
        ...
        if ((defVN != incrementVN) && !notInLoop) {
          ...
          isInductionVariable = false;
          if (trace())
            traceMsg(comp(), "      ivInfo is invalid for sym [%p], def [%d] "
                             "node %p does not have the same value number as "
                             "another increment\n",
                     sym, defVN, defNode);
          break;
        }
        ...
        if (entryVN >= 0) {
          ...
          if (_loopInfo->_seenDefs->get(defVN)) {
            ...
            if (trace())
              traceMsg(comp(), "      ivInfo is invalid for sym [%p], def [%d] "
                               "already seen in loop\n",
                       sym, defVN);
            break;
          } else {
            if (trace()) {
              traceMsg(comp(), "      Sym [%p] has more than two defs, extra "
                               "def due to VN [%d]\n",
                       sym, entryVN);
        ...
        if ((defVN != entryVN) && notInLoop) {
          ...
          if (trace())
            traceMsg(comp(), "      ivInfo is invalid for sym [%p], def [%d] "
                             "node %p is likely in some inner loop\n",
                     sym, defVN, defNode);
          break;
        }
      }
  ...
  if (iv) {
    ...
    if (maybeInductionVariable) {
      if (checkLoopTestBlock(sym)) {
        ...
        traceMsg(comp(), "      Could not guess the increment for sym [%p], "
                         "not marked as induction variable\n",
                 sym);
    }
...
void TR::ValuePropagation::setUpInductionVariables(
...
void TR::ValuePropagation::getParmValues() {
  ...
  if (!comp()->getCurrentMethod()->isJ9())
    return; // does not work with multiple entries and seems to be Java specific
            // anyway

  // Allocate the constraints array for the parameters
  //
  _parmValues = (TR::VPConstraint **)trMemory()->allocateStackMemory(
      numParms * sizeof(TR::VPConstraint *));
  ...
  if (!comp()->getCurrentMethod()->isStatic()) {
    if (p && p->getOffset() == 0) {
      ...
      if (usePreexistence()) {
        ...
        if (TR::Compiler->cls.isAbstractClass(comp(), classObject))
          classObject = comp()
                            ...
                            ->findSingleConcreteSubClass(classObject, comp());
        ...
        if (!classObject) {
          ...
          TR_PersistentClassInfo *cl =
              comp()
                  ->getPersistentInfo()
                  ->getPersistentCHTable()
                  ->findClassInfoAfterLocking(classObject, comp());
          if (!cl)
            prexClass = NULL;
          else {
        ...
        if (jlKlass) {
          if (classObject != jlKlass) {
            ...
            constraint = TR::VPObjectLocation::create(
                this, TR::VPObjectLocation::JavaLangClassObject);
          constraint = constraint->intersect(
              TR::VPPreexistentObject::create(this, prexClass), this);
      ...
      if (0 && constraint) // cannot do this if 'this' is changed in the
                           // method...allow the non null property on the
                           // TR::Node set by IL gen to dictate the creation of
                           // non null constraint
      {
        constraint =
            constraint->intersect(TR::VPNonNullObject::create(this), this);
        TR_ASSERT(constraint, "Cannot intersect constraints");
      }
#endif
  ...
  TR_MethodParameterIterator *parmIterator =
      method->getParameterIterator(*comp());
  for (; p; p = parms.getNext()) {
    ...
    if ((dataType == TR::Int8 || dataType == TR::Int16) &&
      ...
      _parmValues[parmIndex++] =
          TR::VPIntRange::create(this, dataType, TR_maybe);
      ...
      if (opaqueClass) {
        ...
        if (usePreexistence()) {
          ...
          if (TR::Compiler->cls.isInterfaceClass(comp(), opaqueClass) ||
              TR::Compiler->cls.isAbstractClass(comp(), opaqueClass))
            opaqueClass = comp()
                              ->getPersistentInfo()
                              ->getPersistentCHTable()
                              ->findSingleConcreteSubClass(opaqueClass, comp());
          ...
          if (!opaqueClass) {
            ...
            TR_PersistentClassInfo *cl =
                comp()
                    ->getPersistentInfo()
                    ->getPersistentCHTable()
                    ->findClassInfoAfterLocking(opaqueClass, comp());
            if (!cl)
              prexClass = NULL;
            else {
              if (!cl->shouldNotBeNewlyExtended())
        ...
        if (prexClass && !fe()->classHasBeenExtended(opaqueClass)) {
          TR_OpaqueClassBlock *jlKlass =
              fe()->getClassClassPointer(opaqueClass);
          if (jlKlass) {
      ...
      } else if (0) // added here since an unresolved parm could be an interface
                    // in which case nothing is known
      {
        char *sig;
        uint32_t len;
        ...
        if (usePreexistence() && parmIterator->isClass()) {
          ...
          if (classObject && !fe()->classHasBeenExtended(classObject))
            constraint = TR::VPFixedClass::create(this, classObject);
          constraint = constraint->intersect(
              TR::VPPreexistentObject::create(this, classObject), this);
          TR_ASSERT(constraint, "Cannot intersect constraints");
        }
      }
#endif
  ...
  TR_ASSERT(parmIterator->atEnd() && parmIndex == numParms,
            "Bad signature for owning method");
}
...
void TR::GlobalValuePropagation::processImproperLoop(
  ...
  // them; however if we wanted to restart analyzin inside them, we must use
  // code
...
void TR::ValuePropagation::generalizeStores(ValueConstraints &stores,
                                            ValueConstraints *vC) {
...
void TR::ValuePropagation::findStoresInBlock(TR::Block *block,
                                             ValueConstraints &stores) {
...
TR::CFGEdge *TR::ValuePropagation::findOutEdge(TR::list<TR::CFGEdge *> &edges,
                                               TR::CFGNode *target) {
...
bool TR::ValuePropagation::isUnreachablePath(
    ValueConstraints &valueConstraints) {
...
void TR::ValuePropagation::printStructureInfo(TR_Structure *s, bool starting,
                                              bool lastTimeThrough) {
...
void TR::ValuePropagation::printValueConstraints(
    ValueConstraints &valueConstraints) {
...
void TR::ValuePropagation::StoreRelationship::print(TR::ValuePropagation *vp,
                                                    int32_t valueNumber,
                                                    int32_t indent) {
  if (vp->comp()->getOutFile() == NULL)
    return;
...
void TR::ValuePropagation::ValueConstraint::print(TR::ValuePropagation *vp,
                                                  int32_t indent) {
  if (vp->comp()->getOutFile() == NULL)
    return;
...
bool TR::ValuePropagation::removeConstraints(int32_t valueNumber,
  ...
  if (trace()) {
    ...
    traceMsg(comp(), "   Intersection of constraints failed for valueNumber "
...
bool TR::ValuePropagation::removeStoreConstraints(
...
bool TR::ValuePropagation::removeConstraints(int32_t valueNumber) {
  if (trace())
    traceMsg(comp(), "   Intersection failed for value number [%d], removing "
                     "global constraints\n",
             valueNumber);
...
int64_t TR::ArraycopyTransformation::arraycopyHighFrequencySpecificLength(
  ...
  if (comp()->getRecompilationInfo()) {
    if (TR::Compiler->target.is64Bit()) {
      TR_LongValueInfo *valueInfo =
          (TR_LongValueInfo *)TR_ValueProfiler::getProfiledValueInfo(
              arrayCopyNode, comp());
      if (valueInfo &&
      ...
      TR_ValueInfo *valueInfo =
          (TR_ValueInfo *)TR_ValueProfiler::getProfiledValueInfo(arrayCopyNode,
                                                                 comp());
      if (valueInfo &&
          valueInfo->getTopProbability() >
              MIN_ARRAYCOPY_FREQ_FOR_SPECIALIZATION) {
...
TR::ArraycopyTransformation::createMultipleArrayNodes(TR::TreeTop *arrayTree,
  ...
  if (!alreadyForwardArrayCopy) {
    ...
    cfg->removeEdge(elseSuccList, outerElseBlock->getNumber(),
                    followOnBlock->getNumber());
    TR::list<TR::CFGEdge *> condSuccList = arraycopyBlock->getSuccessors();
    cfg->removeEdge(condSuccList, arraycopyBlock->getNumber(),
                    ifBlock->getNumber());
...
int32_t TR::ArraycopyTransformation::perform() {
  ...
  // it is intended for platforms that want to generate inline code for both
  // forward
  // and backward arraycopy but don't want to do control flow in the platform
  // code
...
void TR::ValuePropagation::versionBlocks() {
  ...
  for (cur = _blocksToBeVersioned->getFirst(); cur; cur = cur->getNext()) {
    ...
    //
    for (auto nextPred = block->getPredecessors().begin();
         nextPred != block->getPredecessors().end();) {
...
bool TR::ValuePropagation::prepareForBlockVersion(
    TR_LinkHead<ArrayLengthToVersion> *arrayLengths) {
  bool isGlobal;
  ...
  for (TR::Node *bndchkNode = iter.getFirst(); bndchkNode;
    ...
    if (arrayIndexInfoFound) {
      ...
      if (baseNode) {
        ...
        // we need to check that max-c>0 to make sure that delta is positive
        // (less than maxInt)
...
void TR::ValuePropagation::buildBoundCheckComparisonNodes(
  ...
  for (ArrayLengthToVersion *arrayLength = blockInfo->_arrayLengths->getFirst();
    ...
    for (ArrayIndexInfo *arrayIndex =
      ...
      if (performTransformation(comp(), "%s Creating tests outside block_%d "
    ...
    if (arrayLengthVersioned) {
      if (arrayLength->_arrayLen->getOpCode().isArrayLength()) {
        ...
        if (objectRefChild && !objectRefChild->isNonNull()) {
          dumpOptDetails(comp(), "%s Creating test for nullCheck of %p outside "
        ...
        if (arrayLength->_instanceOfClass && objectRefChild &&
          ...
          dumpOptDetails(
              comp(), "%s Creating test for instanceof of %p outside block_%d "
                      "for versioning arraylenth %p \n",
...
void TR::ValuePropagation::removeBndChecksFromFastVersion(
...
TR::Node *TR::ValuePropagation::findVarOfSimpleFormOld(
...
// an invariant;
// i has to be any subtree, but its children are walked through, and if they
// have a symbol reference
// they have to be either a param or an auto (we are trying to avoid object
// fields)
// and of course they have to be not defined before then; see design 1839
TR::Node *TR::ValuePropagation::findVarOfSimpleForm(
    TR::Node *node) // ArrayIndexNodeFromOffset(TR::Node *node, int32_t stride)
{
  if (node->getOpCode().hasSymbolReference() &&
      !node->hasUnresolvedSymbolReference() &&
...
void TR::ValuePropagation::createNewBucketForArrayIndex(
        ...
        if (opCode.getOpCodeValue() == TR::istore) {
          ...
          if (load &&
              symReference->getReferenceNumber() ==
                  load->getSymbolReference()->getReferenceNumber()) { // check
                                                                      // if this
                                                                      // is the
                                                                      // first
                                                                      // time
...
void TR::ValuePropagation::addToSortedList(
    TR_LinkHead<ArrayLengthToVersion> *arrayLengths,
...
TR::TreeTop *TR::ValuePropagation::createReferenceArrayNodeWithoutFlags(
...
void TR::ValuePropagation::transformReferenceArrayCopyWithoutCreatingStoreTrees(
...
void TR::ValuePropagation::transformReferenceArrayCopy(
...
void TR::ValuePropagation::transformUnknownTypeArrayCopy(
    TR_TreeTopWrtBarFlag *arrayTree) {
#ifdef J9_PROJECT_SPECIFIC
  TR::Node *node = arrayTree->_treetop->getNode();
  if (node->getOpCodeValue() != TR::arraycopy)
...
static void changeBranchToGoto(TR::ValuePropagation *vp, TR::Node *guardNode,
                               TR::Block *guard) {
...
void TR::ValuePropagation::transformStringConcats(
    VPStringCached *stringCached) {
  if (!performTransformation(
          comp(), "%sSimplified String Concatenation:(StringCache) [%p] \n",
          OPT_DETAILS, stringCached->_treetop1, stringCached->_treetop2) &&
      getStringCacheRef())
    return;
  ...
  TR::Node *indexNode =
      TR::Node::iconst(appendedString[0], 0); // Length of string 1
  ...
  TR::SymbolReference *symRef =
      getStringCacheRef()
          ? comp()->getSymRefTab()->findOrCreateMethodSymbol(
                stringNode->getSymbolReference()->getOwningMethodIndex(), -1,
                getStringCacheRef()
                    ->getSymbol()
...
TR::SymbolReference *TR::ValuePropagation::getStringCacheRef() {
  ...
  "We need to figure out how to validate and relocate this symbol safely before
  ...
  */
  ...
  stringSymRef = comp()->getSymRefTab()->findOrCreateClassSymbol(
      methodSymbol, -1, stringClass);
  TR_ScratchList<TR_ResolvedMethod> stringMethods(comp()->trMemory());
  comp()->fej9()->getResolvedMethods(comp()->trMemory(), stringClass,
                                     &stringMethods);
  ...
  for (TR_ResolvedMethod *method = it.getCurrent(); method;
    ...
    if (!callsymreference &&
        !strncmp(sig, "(Ljava/lang/String;Ljava/lang/String;I)", 39)) {
      callsymreference = comp()->getSymRefTab()->findOrCreateMethodSymbol(
          JITTED_METHOD_INDEX, -1, method, TR::MethodSymbol::Static);
      break;
    }
  }
...
void TR::ValuePropagation::transformStringCtors(VPTreeTopPair *treeTopPair) {
  ...
  if (!performTransformation(
          comp(), "%sSimplified String Concatenation:(StringCache) [%p] \n",
          OPT_DETAILS, treeTopPair->_treetop1, treeTopPair->_treetop2) &&
      getStringCacheRef())
    return;

  TR::Node *appendedString[2];
  appendedString[0] =
      treeTopPair->_treetop1->getNode()->getFirstChild()->getSecondChild();
  appendedString[1] =
      treeTopPair->_treetop1->getNode()->getFirstChild()->getLastChild();
  ...
  if (!(base1 && base1->isConstString() && base2 && base2->isConstString())) {
    traceMsg(comp(), "%p, %p not Constant Strings, returning from StringCtors",
             appendedString[0], appendedString[1]);
    return;
  }
  TR::Node *indexNode = TR::Node::iconst(
      treeTopPair->_treetop1->getNode()->getFirstChild()->getSecondChild(), 0);
  ...
  /* Before After
    ...
    treetop
        loadaddr
    acall  Method[java/lang/String.cachedConstantString]
                                                                                aload
                                                                                aload
                                                                                iconst
  */

  treeTopPair->_treetop2->getNode()
      ->getFirstChild()
      ->getFirstChild()
      ->decReferenceCount();
  TR::Node::recreate(treeTopPair->_treetop2->getNode()->getFirstChild(),
                     TR::acall);
  ...
  TR::SymbolReference *symRef =
      getStringCacheRef()
          ? comp()->getSymRefTab()->findOrCreateMethodSymbol(
                ...
                TR::MethodSymbol::Static)
          : 0;
  treeTopPair->_treetop2->getNode()->getFirstChild()->setSymbolReference(
      symRef);
  treeTopPair->_treetop2->getNode()->getFirstChild()->setAndIncChild(
      0, appendedString[0]);
  treeTopPair->_treetop2->getNode()->getFirstChild()->setAndIncChild(
      1, appendedString[1]);
  treeTopPair->_treetop2->getNode()->getFirstChild()->setAndIncChild(2,
                                                                     indexNode);
...
void TR::ValuePropagation::replacePackedArrayLoad(TR::Node *loadNode,
                                                  TR::Node *packedNode,
                                                  TR::Node *curNode,
                                                  vcount_t visitCount) {
  ...
  for (uint16_t i = 0; i < curNode->getNumChildren(); i++) {
    ...
    if (childNode == loadNode) {
      ...
      if (trace())
        traceMsg(comp(), "Replacing child %d of node [" POINTER_PRINTF_FORMAT
                         "] from load node [" POINTER_PRINTF_FORMAT
                         "] to packed node [" POINTER_PRINTF_FORMAT "]\n",
...
bool TR::ValuePropagation::checkAllUnsafeReferences(TR::Node *node,
                                                    vcount_t visitCount) {
  if (node->getVisitCount() == visitCount)
    return true;
...
void TR::ValuePropagation::doDelayedTransformations() {
  ...
  for (stringCache = treesIt0.getFirst(); stringCache;
       stringCache = treesIt0.getNext()) {
  ...
  for (treeTopPair = treesIt2.getFirst(); treeTopPair;
       treeTopPair = treesIt2.getNext()) {
    traceMsg(comp(), "Transforming call now in do-delayed");
  ...
  if (_edgesToBeRemoved) {
    for (i = _edgesToBeRemoved->size() - 1; i >= 0; --i) {
      ...
      // otherwise the CFG could
      // be incorrect (for example, if a conditional branch was converted to a
      // goto, you have to remove
            ...
            if (guard && (guard->getSuccessors().size() == 2) &&
              ...
              if (guardNode) {
                ...
                canBeRemoved =
                    ...
                    callNode->getOpCode().isCallDirect(); // do not remove
                                                          // guards for indirect
                                                          // calls. If the
                                                          // ifacmpne handler
                // didn't do it, the chances are it is illegal to remove the
                // guard
              } else
                canBeRemoved = true;
              ...
              if (guardNode && guardNode->isProfiledGuard()) {
                ...
                if (classTypeNode->getOpCodeValue() == TR::aconst &&
                  ...
                  TR_ASSERT((classTypeNode->getOpCodeValue() == TR::aconst &&
                            ...
                            "Devirtualization of guarded profiled calls only "
                            "works currently for vft-guards or method compare "
                            "guards");
                ...
                if (typeCompatibleStatus == TR_no) {
                  ...
                  if ((guardType == 1) &&
                      performTransformation(
                          comp(), "%sChanging branch (guard) %p in block_%d to "
                    ...
                    callUnreachable = false;
                             ...
                             performTransformation(
                                 comp(), "%sRemoving branch %p in block_%d due "
                                         "to devirtualization\n",
                                 OPT_DETAILS, guardNode, guard->getNumber())) {
                    // remove branch
                  ...
                  if ((guardType == 1) &&
                      performTransformation(
                          comp(), "%sRemoving branch %p in block_%d due to "
                                  "devirtualization\n",
                          OPT_DETAILS, guardNode, guard->getNumber())) {
                    // remove branch
                    guard->removeBranch(comp());
                    // callUnreachable true;
                             ...
                             performTransformation(
                                 comp(), "%sChanging branch (guard) %p in "
                                         "block_%d to goto due to "
                                         "devirtualization\n",
                                 OPT_DETAILS, guardNode, guard->getNumber())) {
                    // change the if to goto
                    changeBranchToGoto(this, guardNode, guard);
  ...
  for (VirtualGuardInfo *cvg = _convertedGuards.getFirst(); cvg;
    ...
    if (!oldNode ||
        !performTransformation(
            comp(), "%sReplacing the old guard %p with the shiny new "
  ...
  for (predictedThrow = throwsIt.getFirst(); predictedThrow;
    ...
    TR::Node *firstReferenceOfCatchObject =
        predictedCatchBlock->findFirstReference(excpSymRef->getSymbol(),
                                                comp()->incVisitCount());
    ...
    if (firstNode->getOpCodeValue() == TR::astore &&
      ...
      if (firstReferenceOfCatchObject->getReferenceCount() > 1) {
        ...
        // of exception symbol
        //
        firstNode->setAndIncChild(0,
                                  TR::Node::createLoad(firstNode, excpSymRef));
        firstReferenceOfCatchObject->setSymbolReference(
      ...
      TR::Node::recreate(
          node, node->getReferenceCount() == 0 ? TR::treetop : TR::PassThrough);
    else
      firstTT = 0;

    if (firstTT &&
        performTransformation(comp(), "%sChanging a throw [%p] to a goto\n",
                              OPT_DETAILS, node)) {
      invalidateUseDefInfo();
      invalidateValueNumberInfo();
      ...
      TR_ASSERT(!predictedCatchBlock->specializedDesyncCatchBlock(),
                "we've assumed that we would convert this throw to a goto");
      if (debug("traceThrowToGoto"))
        printf("\n unable to convert throw to goto in %s ",
               comp()->signature());
    }
  }
  ...
  TR_OpaqueClassBlock *optClnClass = comp()->fe()->getClassFromSignature(
      "packagePlaceholder/OptCloneClass", 32, comp()->getCurrentMethod());
  ...
  if (clnCallNode && optClnClass) {
    ...
    comp()->fej9()->getResolvedMethods(comp()->trMemory(), optClnClass,
                                       &clnMethods);
    ...
    for (method = clnit.getCurrent(); method; method = clnit.getNext()) {
      ...
      if (!strncmp(sig, "packagePlaceholder/OptCloneClass.OptimizedClone(Ljava/"
                        "lang/Object;Ljava/lang/Object;)Ljava/lang/Object;",
                   len)) {
        optClnClassSymRef = comp()->getSymRefTab()->findOrCreateMethodSymbol(
            clnCallNode->getSymbolReference()->getOwningMethodIndex(), -1,
            method, TR::MethodSymbol::Special);
        break;
      }
    }

    // Traverse the clone call lists and the list of potentail src cln classes
    // and mutated the calls.
    //
    TR_OpaqueClassBlock *srcClass = clnClassIt.getCurrent();
    TR::TreeTop *clnTreeTop = clnTreeTopIt.getCurrent();
    for (; clnCallNode && optClnClassSymRef;
         clnCallNode = clnNodeIt.getNext()) {
      // Now, try to transform the Object.clone call to a
      // J9VMInternals.optimizedClone call. This call
      // takes two parameters. The second parameter is reserved for when we can
      // create a new "empty"
      ...
      if (srcClass) {
        ...
        if (!performTransformation(comp(), "%sCreating new object tree [%p] to "
                                           "populate second parameter of "
                                           "optimized clone call [%p] \n",
                                   OPT_DETAILS, newTreeNode, clnCallNode)) {
          srcClass = NULL;
        } else {
          // Create a new instance and common the node with the second parameter
          // to the optimized clone call.
          //
          if (performTransformation(
                  comp(), "%sTransforming Object.Clone call node [%p] to "
                          "J9VMIntenrals.optimizedClone call \n",
                  OPT_DETAILS, clnCallNode)) {
            TR::Node *newNode = TR::Node::createWithSymRef(
                clnCallNode, TR::New, 1,
                comp()->getSymRefTab()->findOrCreateNewObjectSymbolRef(
                    clnCallNode->getFirstChild()
                        ->getSymbolReference()
                        ->getOwningMethodSymbol(comp())));
            TR::Node *classPtr = TR::Node::createWithSymRef(
                clnCallNode, TR::loadaddr, 0,
                comp()->getSymRefTab()->findOrCreateClassSymbol(
                    clnCallNode->getFirstChild()
                        ->getSymbolReference()
                        ->getOwningMethodSymbol(comp()),
      ...
      if (srcClass == NULL) {
        // Cannot create a new instance of the source object's class, therefore,
        // second argument is NULL.
        //
        if (performTransformation(comp(),
                                  "%sTransforming Object.Clone call node [%p] "
                                  "to J9VMIntenrals.optimizedClone call \n",
                                  OPT_DETAILS, node)) {
          TR::Node *nullNode = TR::Node::aconst(clnCallNode, 0);
          clnCallNode->setNumChildren(2);
          clnCallNode->setChild(
              0, clnCallNode->getChild(clnCallNode->getFirstArgumentIndex()));
