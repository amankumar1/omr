...
public:
  ...
  static TR::VPConstraint *create(TR::ValuePropagation *vp, const char *sig,
...
protected:
  ...
  class Tracer {
  public:
    Tracer(TR::ValuePropagation *vp, TR::VPConstraint *self,
  ...
  type_t addWithOverflow(type_t a, type_t b, bool &overflow) {
    ...
    // overflows. This happens exactly
    // when both operand have the same sign and the resulting value has the
    // opposite sign to this.
    // A non-negative result from xoring two numbers indicates that their sign
    // bits are either both
    // set, or both unset, meaning they have the same sign, while a negative
    // result from xoring two
    // numbers means that exactly one of them has its sign bit set, meaning the
  ...
  type_t subWithOverflow(type_t a, type_t b, bool &overflow) {
    ...
    // difference overflows. This happens exactly
    // when both operand bounds have a differing sign and the resulting value
    // has the same sign as the first operand.
    // A non-negative result from xoring two numbers indicates that their sign
    // bits are either both
    // set, or both unset, meaning they have the same sign, while a negative
    // result from xoring two
...
public:
  ...
  // static TR::VPConstraint *createExclusion(TR::ValuePropagation *vp, int32_t
  // v);
...
public:
  ...
  static TR::VPShortConstraint *create(TR::ValuePropagation *vp, int16_t low,
                                       int16_t high,
                                       TR_YesNoMaybe canOverflow = TR_no);
  static TR::VPShortConstraint *create(TR::ValuePropagation *vp);
  static TR::VPShortConstraint *createWithPrecision(TR::ValuePropagation *vp,
                                                    int32_t precision,
...
public:
  ...
  virtual TR::VPConstraint *merge1(TR::VPConstraint *other,
                                   TR::ValuePropagation *vp);
  // unsigned intMerge
  // TR::VPConstraint *merge1(TR::VPConstraint *other, TR::ValuePropagation *vp,
  // bool isUnsigned);
  virtual TR::VPConstraint *intersect1(TR::VPConstraint *other,
                                       TR::ValuePropagation *vp);
  // unsigned intIntersect
  // TR::VPConstraint *intersect1(TR::VPConstraint *other, TR::ValuePropagation
  // *vp, bool isUnsigned);
  virtual bool mustBeNotEqual(TR::VPConstraint *other,
                              TR::ValuePropagation *vp);
  virtual bool mustBeLessThan(TR::VPConstraint *other,
  ...
  virtual TR::VPConstraint *subtract(TR::VPConstraint *other, TR::DataType type,
                                     TR::ValuePropagation *vp);
  // unsigned add
  // TR::VPConstraint *add(TR::VPIntConstraint *other, TR::ValuePropagation *vp,
  // bool isUnsigned);
  // unsigned subtract
  // TR::VPConstraint *subtract(TR::VPIntConstraint *other, TR::ValuePropagation
  // *vp, bool isUnsigned);
...
public:
  ...
  // static TR::VPIntConstraint *create(TR::ValuePropagation *vp, int32_t low,
  // int32_t high);
  static TR::VPIntConstraint *create(TR::ValuePropagation *vp, int32_t low,
                                     int32_t high,
                                     TR_YesNoMaybe canOverflow = TR_no);
  static TR::VPIntConstraint *
  create(TR::ValuePropagation *vp, TR::DataTypes dt,
         TR_YesNoMaybe isUnsigned); // Takes a TR::DataTypes instead of
                                    // TR::DataType to work around ambiguous
                                    // overloads
  static TR::VPIntConstraint *createWithPrecision(TR::ValuePropagation *vp,
                                                  TR::DataType dt,
                                                  int32_t precision,
...
public:
  ...
  static TR::VPLongConstraint *create(TR::ValuePropagation *vp, int64_t low,
...
public:
  ...
  create(TR::ValuePropagation *vp, TR::VPClassType *type,
  ...
  void typeIntersect(TR::VPClassPresence *&presence, TR::VPClassType *&type,
                     TR::VPConstraint *other, TR::ValuePropagation *vp);
  virtual bool mustBeEqual(TR::VPConstraint *other, TR::ValuePropagation *vp);
  virtual bool mustBeNotEqual(TR::VPConstraint *other,
                              TR::ValuePropagation *vp);
...
public:
  ...
  static TR::VPClassType *create(TR::ValuePropagation *vp,
                                 TR::SymbolReference *symRef, bool isFixedClass,
                                 bool isPointerToClass = false);
  static TR::VPClassType *create(TR::ValuePropagation *vp, const char *sig,
                                 int32_t len, TR_ResolvedMethod *method,
                                 bool isFixed,
  ...
  virtual bool isJavaLangObject(TR::ValuePropagation *vp) {
...
public:
  ...
  static TR::VPResolvedClass *create(TR::ValuePropagation *vp,
...
public:
  ...
  static TR::VPFixedClass *create(TR::ValuePropagation *vp,
                                  TR_OpaqueClassBlock *klass);
...
public:
  static TR::VPConstString *create(TR::ValuePropagation *vp,
                                   TR::SymbolReference *symRef);
...
public:
  ...
  static TR::VPUnresolvedClass *create(TR::ValuePropagation *vp,
...
public:
  ...
  static TR::VPPreexistentObject *create(TR::ValuePropagation *vp,
...
public:
  ...
  static TR::VPArrayInfo *create(TR::ValuePropagation *vp, int32_t lowBound,
...
public:
  ...
  static TR::VPObjectLocation *create(TR::ValuePropagation *vp,
...
protected:
  ...
  static TR::VPKnownObject *create(TR::ValuePropagation *vp,
...
public:
  ...
  createForJavaLangClass(TR::ValuePropagation *vp,
                         TR::KnownObjectTable::Index index) {
...
class VPImplementedInterface : public TR::VPConstraint
   ...
   static  TR::VPImplementedInterface *create(TR::ValuePropagation *vp, char
...
public:
  ...
  static TR::VPMergedConstraints *create(TR::ValuePropagation *vp,
...
private:
  ...
  //   ListElement<TR::VPConstraint> *otherNext, TR::ValuePropagation *vp, bool
  //   isUnsigned);
...
public:
  ...
  virtual TR::VPConstraint *
  propagateRelativeConstraint(TR::VPRelation *other, int32_t relative,
                              int32_t otherRelative, TR::ValuePropagation *vp);
...
public:
  ...
  static TR::VPGreaterThanOrEqual *create(TR::ValuePropagation *vp,
                                          int32_t incr);
  virtual TR::VPConstraint *merge1(TR::VPConstraint *other,
                                   TR::ValuePropagation *vp);
  virtual TR::VPConstraint *intersect1(TR::VPConstraint *other,
