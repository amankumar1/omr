...
private:
  ...
  void simpleIterator(TR_Stack<int32_t> &workStack, SparseBitVector &vector,
  ...
  public:
    StructInfo(const TR::Allocator &allocator)
        : _pred(allocator), _succ(allocator), _exceptionPred(allocator),
          _exceptionSucc(allocator) {}
  ...
  TR_RegionAnalysis(TR::Compilation *comp, TR_Dominators &dominators,
                    TR::CFG *cfg, const TR::Allocator &allocator)
