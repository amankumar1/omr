...
const OptimizationStrategy cheapObjectAllocationOpts[] = {
    ...
    // basicBlockHoisting,                     // merge block into pred and
    // prepare for local dead store
...
const OptimizationStrategy partialRedundancyEliminationOpts[] = {
...
#ifdef J9_PROJECT_SPECIFIC
    {escapeAnalysis, IfEAOpportunitiesMarkLastRun}, // to stack-allocate after
                                                    // loopversioner and
                                                    // localCSE
#endif
    ...
    {treesCleansing}, // clean up gotos in code and convert to fall-throughs for
                      // loop reducer
    {redundantGotoElimination, IfNotProfiling}, // clean up for loop reducer.
                                                // Note: NEVER run this before
                                                // PRE
    {loopReduction,
...
static const OptimizationStrategy tacticalGlobalRegisterAllocatorOpts[] = {
    ...
    {OMR::redundantGotoElimination,
     OMR::IfEnabledAndNotProfiling}, // if global register allocator created new
                                     // block
    {OMR::deadTreesElimination},     // remove dangling GlRegDeps
    {OMR::deadTreesElimination, OMR::IfEnabled}, // remove dead RegStores
...
const OptimizationStrategy finalGlobalOpts[] = {
    ...
    {compactLocals,
     IfNotProfiling}, // analysis results are invalidated by profilingGroup
#ifdef J9_PROJECT_SPECIFIC
...
OMR::Optimizer::Optimizer(TR::Compilation *comp,
  ...
  _opts[OMR::basicBlockPeepHole] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_PeepHoleBasicBlocks::create,
                              ...
                              "O^O BASIC BLOCK PEEPHOLE: ");
  _opts[OMR::blockShuffling] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_BlockShuffling::create,
                              OMR::blockShuffling, "O^O BLOCK SHUFFLING: ");
  _opts[OMR::blockSplitter] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_BlockSplitter::create,
                              OMR::blockSplitter, "O^O BLOCK SPLITTER: ");
  _opts[OMR::catchBlockRemoval] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_CatchBlockRemover::create,
                              ...
                              "O^O CATCH BLOCK REMOVAL: ");
  _opts[OMR::CFGSimplification] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_CFGSimplifier::create,
                              OMR::CFGSimplification,
                              "O^O CFG SIMPLIFICATION: ");
  _opts[OMR::checkcastAndProfiledGuardCoalescer] = new (comp->allocator())
      TR::OptimizationManager(self(),
                              ...
                              OMR::checkcastAndProfiledGuardCoalescer,
                              "O^O CHECKCAST AND PROFILED GUARD COALESCER: ");
  _opts[OMR::coldBlockMarker] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_ColdBlockMarker::create,
                              OMR::coldBlockMarker, "O^O COLD BLOCK MARKER: ");
  _opts[OMR::coldBlockOutlining] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_ColdBlockOutlining::create,
                              OMR::coldBlockOutlining,
                              "O^O COLD BLOCK OUTLINING: ");
  _opts[OMR::compactLocals] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_CompactLocals::create,
                              OMR::compactLocals, "O^O COMPACT LOCALS: ");
  ...
  _opts[OMR::invariantArgumentPreexistence] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_InvariantArgumentPreexistence::create,
                              ...
                              "O^O INVARIANT ARGUMENT PREEXISTENCE: ");
  _opts[OMR::loadExtensions] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_LoadExtensions::create,
                              OMR::loadExtensions, "O^O LOAD EXTENSION: ");
  _opts[OMR::localCSE] = new (comp->allocator())
      TR::OptimizationManager(self(), TR::LocalCSE::create, OMR::localCSE,
                              "O^O LOCAL COMMON SUBEXPRESSION ELIMINATION: ");
  _opts[OMR::localDeadStoreElimination] = new (comp->allocator())
      TR::OptimizationManager(self(), TR::LocalDeadStoreElimination::create,
                              OMR::localDeadStoreElimination,
                              "O^O LOCAL DEAD STORE ELIMINATION: ");
  _opts[OMR::localLiveRangeReduction] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_LocalLiveRangeReduction::create,
                              ...
                              "O^O LOCAL LIVE RANGE REDUCTION: ");
  _opts[OMR::localReordering] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_LocalReordering::create,
                              OMR::localReordering, "O^O LOCAL REORDERING: ");
  _opts[OMR::longRegAllocation] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_LongRegAllocation::create,
                              OMR::longRegAllocation,
                              "O^O LONG REG ALLOCATION: ");
  _opts[OMR::loopCanonicalization] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_LoopCanonicalizer::create,
                              ...
                              "O^O LOOP CANONICALIZER: ");
  _opts[OMR::loopVersioner] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_LoopVersioner::create,
                              OMR::loopVersioner, "O^O LOOP VERSIONER: ");
  _opts[OMR::loopReduction] = new (comp->allocator()) TR::OptimizationManager(
      self(), TR_LoopReducer::create, OMR::loopReduction, "O^O LOOP REDUCER: ");
  _opts[OMR::loopReplicator] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_LoopReplicator::create,
                              OMR::loopReplicator, "O^O LOOP REPLICATOR: ");
  ...
  _opts[OMR::redundantInductionVarElimination] = new (comp->allocator())
      TR::OptimizationManager(self(),
                              ...
                              "O^O REDUNDANT INDUCTION VAR ELIMINATION: ");
  _opts[OMR::partialRedundancyElimination] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_PartialRedundancy::create,
                              ...
                              "O^O PARTIAL REDUNDANCY ELIMINATION: ");
  _opts[OMR::loopInversion] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_LoopInverter::create,
                              OMR::loopInversion, "O^O LOOP INVERTER: ");
  _opts[OMR::inductionVariableAnalysis] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_InductionVariableAnalysis::create,
                              OMR::inductionVariableAnalysis,
                              "O^O INDUCTION VARIABLE ANALYSIS: ");
  ...
  _opts[OMR::prefetchInsertion] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_PrefetchInsertion::create,
                              ...
                              "O^O PREFETCH INSERTION: ");
  _opts[OMR::stripMining] = new (comp->allocator()) TR::OptimizationManager(
      self(), TR_StripMiner::create, OMR::stripMining, "O^O STRIP MINER: ");
  ...
  _opts[OMR::reorderArrayIndexExpr] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_IndexExprManipulator::create,
                              ...
                              "O^O ARRAY INDEX EXPRESSION MANIPULATION: ");
  _opts[OMR::loopStrider] = new (comp->allocator()) TR::OptimizationManager(
      self(), TR_LoopStrider::create, OMR::loopStrider, "O^O LOOP STRIDER: ");
  _opts[OMR::osrDefAnalysis] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_OSRDefAnalysis::create,
                              OMR::osrDefAnalysis, "O^O OSR DEF ANALYSIS: ");
  ...
  _opts[OMR::liveRangeSplitter] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_LiveRangeSplitter::create,
                              ...
                              "O^O LIVE RANGE SPLITTER: ");
  _opts[OMR::loopSpecializer] = new (comp->allocator())
      TR::OptimizationManager(self(), TR_LoopSpecializer::create,
                              OMR::loopSpecializer, "O^O LOOP SPECIALIZER: ");
  ...
  _opts[OMR::lateLocalGroup] = new (comp->allocator()) TR::OptimizationManager(
      self(), NULL, OMR::lateLocalGroup, "", lateLocalOpts);
...
int32_t OMR::Optimizer::optimize() {
  ...
  if (TR::Options::getCmdLineOptions()->getOption(
          TR_EnableDeterministicOrientedCompilation) &&
    ...
    if (manager->getRequiresStructure() &&
      ...
      if (doTiming) {
        ...
        statStructuralAnalysisTiming.update(
            ...
            TR::Compiler->vm.getHighResClockResolution(comp()));
      }
#endif
    }
    ...
    if (manager->getRequiresGlobalsUseDefInfo() ||
      ...
      if (!cantBuildGlobalsUseDefInfo() &&
        ...
        TR::LexicalMemProfiler mp("use defs (for globals definitely)",
                                  comp()->phaseMemProfiler());
        useDefInfo = new (comp()->allocator())
            TR_UseDefInfo(comp(), comp()->getFlowGraph(), self(),
...
// dumpOptDetails(comp(), "\n");
    ...
    if (manager->getRequiresStructure() &&
      ...
      if (checkNumberOfLoopsAndBasicBlocks(
        ...
        if (comp()->getOption(TR_ProcessHugeMethods)) {
          dumpOptDetails(comp(), "Method is normally too large (%d blocks and "
                                 "%d loops) but limits overridden\n",
      ...
      if (comp->fe()->isCompiledMethod(method)) {
        TR_PersistentJittedBodyInfo *bodyInfo =
            TR::Recompilation::getJittedBodyInfoFromPC(
                comp->fe()->getMethodStartPC(method));
  ...
  if (opCode1.isSwitch() == 0) {
    ...
    if (opCode1.isLoadConst()) {
      ...
      if (node1->isDecimalSizeAndShapeEquivalent(node2)) {
        ...
        // enable matching up loads/stores
        // However since sign state is not tracked (and is not relevant) for
        // stores this causes the equivalence
        // test to unnecessarily fail. The isBCDStoreTemporarilyALoad flag allow
        // skipping of the sign state compare
        // for these cases.
        if (!(node1->getOpCode().isLoadVar() &&
          ...
          if (allowBCDSignPromotion &&
            ...
            if (_comp->cg()->traceBCDCodeGen())
              traceMsg(_comp, "y^y : found sign state mismatch node1 %s (%p), "
                              "node2 %s (%p) but node1 improves sign state "
                              "over node2\n",
            ...
            if (_comp->cg()->traceBCDCodeGen())
              traceMsg(_comp, "x^x : found sign state mismatch node1 %s (%p), "
                              "node2 %s (%p)\n",
                       node1->getOpCode().getName(), node1,
                       node2->getOpCode().getName(), node2);
            return false;
...
bool OMR::Optimizer::getLastRun(OMR::Optimizations opt) {
  TR_ASSERT(_opts[opt],
            "Optimization manager for %d should be initialized first", opt);
