...
namespace TR {
class X86RestoreVMThreadInstruction;
}
namespace TR {
...
namespace TR {
class X86ScratchArgHelperCallSnippet;
}
namespace TR {
class UnresolvedDataSnippet;
}
namespace TR {
class X86UnresolvedVirtualCallSnippet;
}
namespace TR {
...
namespace TR {
class AMD64FPConversionSnippet;
}
...
namespace TR {
class IA32WriteBarrierSnippet;
}
namespace TR {
class AMD64WriteBarrierSnippet;
}
namespace TR {
class X86JNIPauseSnippet;
}
namespace TR {
class X86PassJNINullSnippet;
}
namespace TR {
class X86HeapAllocationSnippet;
}
namespace TR {
...
namespace TR {
class S390WarmToColdTrampolineSnippet;
}
namespace TR {
...
namespace TR {
class S390InterfaceCallDataSnippet;
}
namespace TR {
...
public:
  ...
  virtual bool methodSigCanBeFound(const char *, TR::CompilationFilters *,
                                   TR_FilterBST *&, TR_Method::Type methodType);
...
#ifdef J9_PROJECT_SPECIFIC
  int32_t printRestartJump(TR::FILE *, TR::AMD64WriteBarrierSnippet *,
                           uint8_t *);
#endif
  ...
  int32_t printHexConstant(TR::FILE *pOutFile, int64_t value, int8_t width,
                           bool padWithZeros);
  int32_t printFPConstant(TR::FILE *pOutFile, void *value, int8_t numBits,
                          bool printAsBytes = false);
  ...
  uint8_t *printArgs(TR::FILE *, TR::AMD64WriteBarrierSnippet *, bool,
                     uint8_t *);
