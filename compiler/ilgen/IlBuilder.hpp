...
namespace TR {
typedef TR::SymbolReference IlValue;
}
namespace TR {
class IlType;
}
...
public:
  ...
  TR::IlValue *LoadIndirect(const char *type, const char *field,
                            TR::IlValue *object);
  TR::IlValue *StoreField(const char *name, TR::IlValue *object,
                          TR::IlValue *value);
...
protected:
  ...
  void ifCmpNotEqual(TR::IlValue *condition, TR::IlValue *zero,
                     TR::Block *target);
  ...
  void ifCmpLessThan(TR::IlValue *condition, TR::IlValue *zero,
                     TR::Block *target);
  void ifCmpGreaterThan(TR::IlValue *condition, TR::IlValue *zero,
                        TR::Block *target);
  ...
  TR::IlValue *operationWithOverflow(TR::ILOpCodes op, TR::Node *leftNode,
                                     TR::Node *rightNode,
