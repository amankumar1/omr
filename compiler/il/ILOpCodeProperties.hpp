...

{
...

    {
        ...
        /* .properties2          = */ ILProp2::ValueNumberShare |
            ILProp2::SupportedForPRE | ILProp2::MayUseVMThread |
...

    {
        ...
        /* .properties1          = */ ILProp1::Store | ILProp1::TreeTop |
            ILProp1::HasSymbolRef,
        /* .properties2          = */ ILProp2::ValueNumberShare |
            ILProp2::MayUseVMThread | ILProp2::MayUseSystemStack,
...

    {
        ...
        /* .properties1          = */ ILProp1::Store | ILProp1::TreeTop |
            ILProp1::HasSymbolRef,
        /* .properties2          = */ ILProp2::ValueNumberShare |
            ILProp2::WriteBarrierStore | ILProp2::MayUseVMThread |
            ILProp2::MayUseSystemStack,
        /* .properties3          = */ ILProp3::LikeDef,
        /* .properties4          = */ 0,
        /* .dataType             = */ TR::Address,
...

    {
        ...
        /* .properties2          = */ ILProp2::MayUseVMThread |
            ILProp2::MayUseSystemStack,
        /* .properties3          = */ 0,
        /* .properties4          = */ 0,
        /* .dataType             = */ TR::Int32,
...

    {
        ...
        /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
        /* .properties2          = */ ILProp2::MustBeLowered |
            ILProp2::CanRaiseException | ILProp2::MayUseVMThread |
            ILProp2::MayUseSystemStack,
        /* .properties3          = */ 0,
        /* .properties4          = */ 0,
        /* .dataType             = */ TR::NoType,
...

    {
        ...
        /* .properties2          = */ ILProp2::ValueNumberShare |
            ILProp2::SupportedForPRE | ILProp2::MayUseVMThread |
            ILProp2::MayUseSystemStack | ILProp2::LoadAddress,
        /* .properties3          = */ ILProp3::LikeUse,
        /* .properties4          = */ 0,
        /* .dataType             = */ TR::Address,
        /* .typeProperties       = */ ILTypeProp::Reference,
...

    {
        ...
        /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
        /* .properties2          = */ ILProp2::CanRaiseException |
            ILProp2::Check | ILProp2::MayUseVMThread |
            ILProp2::MayUseSystemStack,
        /* .properties3          = */ 0,
        /* .properties4          = */ 0,
        /* .dataType             = */ TR::NoType,
...

    {
        ...
        /* .properties4          = */ 0,
        /* .dataType             = */ TR::
            VectorInt32, /* todo: is it typeless? */
        /* .typeProperties       = */ ILTypeProp::Size_16 |
            ILTypeProp::Integer | ILTypeProp::Vector |
...

    {
        ...
        /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
        /* .properties2          = */ ILProp2::CanRaiseException |
            ILProp2::Check | ILProp2::CheckCast | ILProp2::MayUseVMThread |
            ILProp2::MayUseSystemStack,
        /* .properties3          = */ 0,
        /* .properties4          = */ 0,
        /* .dataType             = */ TR::Address,
...

    {
        ...
        /* .properties1          = */ ILProp1::HasSymbolRef,
        /* .properties2          = */ ILProp2::CanRaiseException |
            ILProp2::MayUseVMThread | ILProp2::MayUseSystemStack | ILProp2::New,
        /* .properties3          = */ ILProp3::LikeDef,
        /* .properties4          = */ 0,
        /* .dataType             = */ TR::Address,
        /* .typeProperties       = */ ILTypeProp::Reference,
...

    {
        ...
        /* .properties2          = */ ILProp2::ValueNumberShare |
            ...
            ILProp2::ResolveCheck | ILProp2::MayUseVMThread |
            ILProp2::MayUseSystemStack,
        /* .properties3          = */ ILProp3::LikeDef,
        /* .properties4          = */ 0,
        /* .dataType             = */ TR::Address,
...

    {
        ...
        /* .name                 = */ "OverflowCHK",
        /* .properties1          = */ ILProp1::TreeTop | ILProp1::HasSymbolRef,
        /* .properties2          = */ ILProp2::Check | ILProp2::MayUseVMThread |
            ILProp2::MayUseSystemStack,
        /* .properties3          = */ 0,
        /* .properties4          = */ 0,
        /* .dataType             = */ TR::NoType,
     ...
     * above)
      * This opcode has one child : the wrtbari node corresponding to the
     * reference store
      * that needs to be checked. The rhs object being stored and the lhs array
     * object
      * that is being stored to are picked up from the wrtbari node's second and
     * third
      * children respectively. The child must therefore remain an wrtbari and
     * not be
      * changed to an astorei even if this is possible if the ArrayStoreCHK node
     * is present.
      *
      */
    {
     ...
     * reference
     * types; this is left to the array store checking done as each copied
     * element
     ...
     */
    {
        ...
        /* .properties1          = */ ILProp1::Call | ILProp1::HasSymbolRef,
        /* .properties2          = */ ILProp2::MayUseVMThread |
            ILProp2::MayUseSystemStack | ILProp2::CanRaiseException | 0,
        /* .properties3          = */ ILProp3::LikeUse | ILProp3::LikeDef |
