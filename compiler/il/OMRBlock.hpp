...
public:
  ...
  TR_BitVector *getRegisterSaveDescriptionBits() {
    return _registerSaveDescriptionBits;
  }
  TR_BitVector *setRegisterSaveDescriptionBits(TR_BitVector *v) {
    return (_registerSaveDescriptionBits = v);
  }
  ...
  // getGlobalNormalizedFrequency multiplies the
