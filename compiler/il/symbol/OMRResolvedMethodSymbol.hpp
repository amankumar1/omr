...
public:
  ...
  List<TR::Block> &getTrivialDeadTreeBlocksList() {
    return _trivialDeadTreeBlocksList;
  }
  List<TR::AutomaticSymbol> &getVariableSizeSymbolList() {
    return _variableSizeSymbolList;
  }
  ListBase<TR::RegisterMappedSymbol> &getMethodMetaDataList() {
    return _methodMetaDataList;
  }
  ...
  bool allCallerOSRBlocksArePresent(int32_t inlinedSiteIndex,
                                    TR::Compilation *comp);
  ...
  TR::TreeTop *genInduceOSRCallForGuardedCallee(
  ...
  TR::TreeTop *
  genInduceOSRCall(TR::TreeTop *insertionPoint, int32_t inlinedSiteIndex,
  ...
  void setHasUnkilledTemps(bool v = true) {
    _properties.set(HasUnkilledTemps, v);
  }
  ...
  bool cannotAttemptOSR(TR_ByteCodeInfo bci, TR::Block *blockToOSRAt,
  ...
  TR::SymbolReference *getPythonConstsSymbolRef() {
    return _pythonConstsSymRef;
  }
