...
public:
   ...
   *
   * \todo Verify the above comment is correct, or at least remap the terms to
  ...
  createRegisterSymbol(AllocatorType m, TR_RegisterKinds regKind,
                       uint32_t globalRegNum, TR::DataType d, uint32_t s,
                       TR_FrontEnd *fe);
