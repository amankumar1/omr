...
public:
  ...
  // The inline To methods perform an explicit (debug) assume that the symbol is
  // a correct type
  ...
  enum {
    ...
    PythonLocalVariable = 0x10000000, // Python local variable shadow  TODO: If
                                      // we ever move this somewhere else, can
                                      // we move UnsafeShadow from flags2 to
                                      // here?
    ...
    // Available                 = 0x10000000,
    IsVMThreadLive = 0x08000000, // reg assigner has determined that vmthread
                                 // must be in the proper register at this label
...
// If these implementations are to be moved, they need to be un-defined as
// inline.
TR::RegisterMappedSymbol *OMR::Symbol::castToRegisterMappedSymbol() {
  TR_ASSERT(isRegisterMappedSymbol(), "OMR::Symbol::castToRegisterMappedSymbol,"
                                      " symbol is not a register mapped "
                                      "symbol");
...
TR::AutomaticSymbol *OMR::Symbol::castToInternalPointerAutoSymbol() {
  TR_ASSERT(isInternalPointerAuto(), "OMR::Symbol::castToInternalAutoSymbol, "
                                     "symbol is not an internal pointer "
                                     "automatic symbol");
  return (TR::AutomaticSymbol *)this;
}

TR::AutomaticSymbol *OMR::Symbol::castToLocalObjectSymbol() {
  TR_ASSERT(isLocalObject(), "OMR::Symbol::castToLocalObjectSymbol, symbol is "
                             "not an internal pointer automatic symbol");
  return (TR::AutomaticSymbol *)this;
}
...
TR::StaticSymbol *OMR::Symbol::castToNamedStaticSymbol() {
  TR_ASSERT(isNamed() && isStatic(), "OMR::Symbol::castToNamedStaticSymbol, "
                                     "symbol is not a named static symbol");
  return (TR::StaticSymbol *)this;
}
...
TR::ResolvedMethodSymbol *OMR::Symbol::castToResolvedMethodSymbol() {
  TR_ASSERT(isResolvedMethod(), "OMR::Symbol::castToResolvedMethodSymbol, "
...
TR::RegisterMappedSymbol *OMR::Symbol::castToMethodMetaDataSymbol() {
  TR_ASSERT(isMethodMetaData(), "OMR::Symbol::castToMethodMetaDataSymbol, "
                                "symbol is not a meta data symbol");
  return (TR::RegisterMappedSymbol *)this;
}
...
TR::ResolvedMethodSymbol *OMR::Symbol::castToJittedMethodSymbol() {
  TR_ASSERT(isJittedMethod(), "OMR::Symbol::castToJittedMethodSymbol, symbol "
                              "is not a resolved method symbol");
  return (TR::ResolvedMethodSymbol *)this;
}

TR::StaticSymbol *OMR::Symbol::castToCallSiteTableEntrySymbol() {
  TR_ASSERT(isCallSiteTableEntry(), "OMR::Symbol::"
                                    "castToCallSiteTableEntrySymbol expected a "
                                    "call site table entry symbol");
  return (TR::StaticSymbol *)this;
}

TR::StaticSymbol *OMR::Symbol::castToMethodTypeTableEntrySymbol() {
  TR_ASSERT(isMethodTypeTableEntry(),
...
TR::AutomaticSymbol *OMR::Symbol::castToRegisterSymbol() {
  TR_ASSERT(isRegisterSymbol(),
            "OMR::Symbol::castToRegisterSymbol expected a register symbol");
  return (TR::AutomaticSymbol *)this;
}

TR::AutomaticSymbol *OMR::Symbol::castToAutoMarkerSymbol() {
  TR_ASSERT(isAutoMarkerSymbol(), "OMR::Symbol::castToAutoMarkerSymbol, symbol "
                                  "is not a auto marker symbol");
  return (TR::AutomaticSymbol *)this;
}

TR::AutomaticSymbol *OMR::Symbol::castToVariableSizeSymbol() {
  TR_ASSERT(isVariableSizeSymbol(), "OMR::Symbol::castToVariableSizeSymbol, "
                                    "symbol is not a VariableSizeSymbol "
                                    "symbol");
  return (TR::AutomaticSymbol *)this;
}
