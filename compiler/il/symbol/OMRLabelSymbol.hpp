...
public:
  ...
  TR::LabelSymbol *getVMThreadRestoringLabel() {
    return _vmThreadRestoringLabel;
  }
  TR::LabelSymbol *setVMThreadRestoringLabel(TR::LabelSymbol *ls) {
    return (_vmThreadRestoringLabel = ls);
  }
