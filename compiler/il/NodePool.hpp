...
public:
  ...
  typedef CS2::TableOf<TR::Node, TR::Allocator, 8, CS2::ABitVector>::Cursor
      NodeIter;

  TR_ALLOC(TR_Memory::Compilation)
  NodePool(TR::Compilation *comp, const TR::Allocator &allocator)
      : _comp(comp), _pool(allocator), _globalIndex(0), _poolIndex(0),
        _disableGC(true), _optAttribGlobalIndex(0), _optAttribPool(allocator) {}
...
private:
  ...
  CS2::TableOf<OMR::Node::OptAttributes, TR::Allocator, 8, CS2::ABitVector>
      _optAttribPool;
};
}
