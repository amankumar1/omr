...
TR::RealRegister *OMR::Z::RealRegister::getHighWordRegister() {
...
TR::RealRegister *OMR::Z::RealRegister::getLowWordRegister() {
  if (_registerNumber >= FirstGPR && _registerNumber <= LastGPR) {
    return self();
  }
  if (_registerNumber >= FirstHPR && _registerNumber <= LastHPR) {
...
TR::RealRegister *OMR::Z::RealRegister::getSiblingWordRegister() {
  if (_registerNumber >= FirstGPR && _registerNumber <= LastGPR) {
    return _highWordRegister;
  }
  if (_registerNumber >= FirstHPR && _registerNumber <= LastHPR) {
...
bool OMR::Z::RealRegister::setHasBeenAssignedInMethod(bool b) {
  if (self()->getAssignedRegister() &&
      (self()->getAssignedRegister()->isUpperBitsAreDirty() ||
       self()->getAssignedRegister()->getKind() == TR_GPR64))
...
bool OMR::Z::RealRegister::isHighWordRegister() {
  return self() == self()->getHighWordRegister();
}

bool OMR::Z::RealRegister::isLowWordRegister() {
...
bool OMR::Z::RealRegister::isPseudoRealReg(RegNum reg) {
  if (reg < FirstGPR || (reg > LastAssignableGPR && reg < FirstFPR) ||
...
// static method
bool OMR::Z::RealRegister::isAR(RegNum reg) {
...
// static method
bool OMR::Z::RealRegister::isHPR(RegNum reg) {
...
// static method
uint64_t OMR::Z::RealRegister::getBitMask(RegNum reg) {
...
// static method
uint64_t OMR::Z::RealRegister::getBitMask(int32_t regNum) {
