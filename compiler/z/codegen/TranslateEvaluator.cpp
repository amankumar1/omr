 ...
 * effect right after trt.
 * It is necessary to map mask and compare value into a semantically equivalent
 * branching condition for direct use.
 */
...
TR::Register *inlineTrtEvaluator(TR::Node *node, TR::CodeGenerator *cg,
  ...
  if (cg->traceBCDCodeGen())
    traceMsg(comp, "\tinlineTrtEvaluator %s (%p) -- numChildren %d, "
                   "storeR1AndR2=%d, isSimple=%d, packR2=%d\n",
