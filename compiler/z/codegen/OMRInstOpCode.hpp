...
#define DC_FORMAT 1
#define E_FORMAT                                                               \
  2 // 83180:  This define is busting a pragma report(level,E) in Node.hpp
#define RR_FORMAT 3
#define RRE_FORMAT 4
#define RRF_FORMAT 5
...
#define IE_FORMAT 34
#define VRIa_FORMAT                                                            \
  35 // VRI denotes a vector register-and-immediate operation and an extended
     // op-code field.
...
#define VRRa_FORMAT                                                            \
  40 // VRR denotes a vector register-and-register operation and an extended
     // op-code field.
...
#define VRSa_FORMAT                                                            \
  46 // VRS denotes a vector register-and-storage operation and an extended
     // op-code field.
#define VRSb_FORMAT 47
#define VRSc_FORMAT 48
#define VRV_FORMAT                                                             \
  49 // VRV denotes a vector register-and-vector-index-storage operation and an
     // extended op-code field.
#define VRX_FORMAT                                                             \
  50 // VRX denotes a vector register-and-index-storage operation and an
     // extended op-code field
...
#define S390OpProp_ReadsMultipleRegs                                           \
  static_cast<uint64_t>(0x0000000000000800ull)
...
#define S390OpProp_ReadsDFPRoundingMode                                        \
  static_cast<uint64_t>(0x0000000008000000ull)
#define S390OpProp_SetsDFPRoundingMode                                         \
...
#define S390OpProp_UsesImplicitRegisters                                       \
  static_cast<uint64_t>(0x0000000080000000ull)
...
#define S390OpProp_MayUseRegPairForTarget                                      \
  static_cast<uint64_t>(0x0000400000000000ull)
...
#define S390OpProp_SSSchedulingCandidate                                       \
  static_cast<uint64_t>(0x0040000000000000ull)
...
#define S390OpProp_IsSignedImmediate                                           \
...
#define S390OpProp2_HasExtendedMnemonic                                        \
  static_cast<uint64_t>(0x0000000000000010ull)
...
public:
  ...
  uint64_t gprOp() {
    return (properties[_mnemonic] &
            (S390OpProp_DoubleFP | S390OpProp_SingleFP)) == 0;
  }
  uint64_t fprOp() {
    return properties[_mnemonic] & (S390OpProp_DoubleFP | S390OpProp_SingleFP);
  }
  ...
  uint64_t isExtendedImmediate() {
    return properties[_mnemonic] & S390OpProp_IsExtendedImmediate;
  }
  uint64_t isSignedImmediate() {
    return properties[_mnemonic] & S390OpProp_IsSignedImmediate;
  }
  ...
  uint64_t usesTarget() {
    return properties[_mnemonic] & S390OpProp_UsesTarget;
  }
  ...
  uint64_t is32to64bit() {
    return properties[_mnemonic] & S390OpProp_Is32To64Bit;
  }

  uint64_t usesImplicitRegisters() {
    return properties[_mnemonic] & S390OpProp_UsesImplicitRegisters;
  }
  uint64_t hasLongDispSupport() {
    return properties[_mnemonic] & S390OpProp_LongDispSupported;
  }
  uint64_t usesRegPairForTarget() {
    return properties[_mnemonic] & S390OpProp_UsesRegPairForTarget;
  }
  uint64_t mayUseRegPairForTarget() {
    return properties[_mnemonic] & S390OpProp_MayUseRegPairForTarget;
  }
  uint64_t usesRegPairForSource() {
    return properties[_mnemonic] & S390OpProp_UsesRegPairForSource;
  }
  uint64_t usesRegRangeForTarget() {
    return properties[_mnemonic] & S390OpProp_UsesRegRangeForTarget;
  }
  uint64_t canUseRegPairForTarget() {
    return usesRegPairForTarget() || usesRegRangeForTarget() ||
           mayUseRegPairForTarget();
  }
  uint64_t shouldUseRegPairForTarget() { return usesRegPairForTarget(); }

  uint64_t implicitlyUsesGPR0() {
    return properties[_mnemonic] & S390OpProp_ImplicitlyUsesGPR0;
  }
  uint64_t implicitlyUsesGPR1() {
    return properties[_mnemonic] & S390OpProp_ImplicitlyUsesGPR1;
  }
  uint64_t implicitlyUsesGPR2() {
    return properties[_mnemonic] & S390OpProp_ImplicitlyUsesGPR2;
  }

  uint64_t implicitlySetsGPR0() {
    return properties[_mnemonic] & S390OpProp_ImplicitlySetsGPR0;
  }
  uint64_t implicitlySetsGPR1() {
    return properties[_mnemonic] & S390OpProp_ImplicitlySetsGPR1;
  }
  uint64_t implicitlySetsGPR2() {
    return properties[_mnemonic] & S390OpProp_ImplicitlySetsGPR2;
  }
  uint64_t implicitlySetsGPR3() {
    return properties[_mnemonic] & S390OpProp_ImplicitlySetsGPR3;
  }
  uint64_t implicitlySetsGPR4() {
    return properties[_mnemonic] & S390OpProp_ImplicitlySetsGPR4;
  }
  uint64_t implicitlySetsGPR5() {
    return properties[_mnemonic] & S390OpProp_ImplicitlySetsGPR5;
  }
  ...
  uint64_t setsCC() {
    return (setsZeroFlag() || setsSignFlag() || setsOverflowFlag() ||
            ...
            (properties[_mnemonic] & S390OpProp_SetsCC));
  }
  uint64_t readsCC() { return properties[_mnemonic] & S390OpProp_ReadsCC; }

  uint64_t readsMultipleRegs() {
    return properties[_mnemonic] & S390OpProp_ReadsMultipleRegs;
  }
  uint64_t setsMultipleRegs() {
    return properties[_mnemonic] & S390OpProp_SetsMultipleRegs;
  }
  uint64_t setsZeroFlag() {
    return properties[_mnemonic] & S390OpProp_SetsZeroFlag;
  }
  uint64_t setsSignFlag() {
    return properties[_mnemonic] & S390OpProp_SetsSignFlag;
  }
  uint64_t setsCarryFlag() {
    return properties[_mnemonic] & S390OpProp_SetsCarryFlag;
  }
  uint64_t setsOverflowFlag() {
    return properties[_mnemonic] & S390OpProp_SetsOverflowFlag;
  }
  uint64_t setsCompareFlag() {
    return properties[_mnemonic] & S390OpProp_SetsCompareFlag;
  }

  uint64_t isRegCopy() { return properties[_mnemonic] & S390OpProp_IsRegCopy; }
  uint64_t hasTwoMemoryReferences() {
    return properties[_mnemonic] & S390OpProp_HasTwoMemoryReferences;
  }

  uint64_t readsDFPRoundingMode() {
    return properties[_mnemonic] & S390OpProp_ReadsDFPRoundingMode;
  }
  uint64_t setsDFPRoundingMode() {
    return properties[_mnemonic] & S390OpProp_SetsDFPRoundingMode;
  }
  ...
  uint64_t mr1IsStore() {
    return properties[_mnemonic] & S390OpProp_MemRefOneIsStore;
  }
  uint64_t mr1IsLoad() {
    return properties[_mnemonic] & S390OpProp_MemRefOneIsLoad;
  }
  uint64_t mr2IsStore() {
    return properties[_mnemonic] & S390OpProp_MemRefTwoIsStore;
  }
  uint64_t mr2IsLoad() {
    return properties[_mnemonic] & S390OpProp_MemRefTwoIsLoad;
  }

  uint64_t isSSSchedulingCandidate() {
    return properties[_mnemonic] & S390OpProp_SSSchedulingCandidate;
  }
  uint64_t isYForm() { return properties[_mnemonic] & S390OpProp_IsYForm; }
  uint64_t isImplicitLoad() {
    return properties[_mnemonic] & S390OpProp_IsImplicitLoad;
  } // like CLCL R1,R2
  uint64_t isImplicitStore() {
    return properties[_mnemonic] & S390OpProp_IsImplicitStore;
  } // like MVCL R1,R2
  ...
  uint64_t hasExtendedMnemonic() {
    return properties2[_mnemonic] & S390OpProp2_HasExtendedMnemonic;
  }
  uint64_t isVectorStringOp() {
    return properties2[_mnemonic] & S390OpProp2_VectorStringOp;
  }
  uint64_t isVectorFPOp() {
    return properties2[_mnemonic] & S390OpProp2_VectorFPOp;
  }
  ...
  static uint8_t getInstructionFormat(Mnemonic i_opCode) {
    return binaryEncodings[i_opCode].instructionFormat;
  }
  static const uint8_t *getOpCodeBinaryRepresentation(Mnemonic i_opCode) {
    return binaryEncodings[i_opCode].bytes;
  }
