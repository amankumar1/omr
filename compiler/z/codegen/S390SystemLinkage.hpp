...
namespace OMR {
typedef TR_S390SystemLinkage SystemLinkageConnector;
}
#endif
...
class TR_S390SystemLinkage : public TR::Linkage {
  ...
  TR_Array<TR::SymbolReference *>
      *_autoMarkerSymbols; // symbols that mark points in stackframe
...
public:
  ...
  int16_t setHPRSaveMask(int16_t HPRSaveMask) {
    return _HPRSaveMask = HPRSaveMask;
  }
  ...
  int32_t setARSaveAreaBeginOffset(int32_t ARSaveAreaBeginOffset) {
    return _ARSaveAreaBeginOffset = ARSaveAreaBeginOffset;
  }
  int32_t getARSaveAreaBeginOffset() { return _ARSaveAreaBeginOffset; }
  int32_t setARSaveAreaEndOffset(int32_t ARSaveAreaEndOffset) {
    return _ARSaveAreaEndOffset = ARSaveAreaEndOffset;
  }
  int32_t getARSaveAreaEndOffset() { return _ARSaveAreaEndOffset; }

  int32_t setHPRSaveAreaBeginOffset(int32_t HPRSaveAreaBeginOffset) {
    return _HPRSaveAreaBeginOffset = HPRSaveAreaBeginOffset;
  }
  int32_t getHPRSaveAreaBeginOffset() { return _HPRSaveAreaBeginOffset; }
  int32_t setHPRSaveAreaEndOffset(int32_t HPRSaveAreaEndOffset) {
    return _HPRSaveAreaEndOffset = HPRSaveAreaEndOffset;
  }
  ...
  int32_t setVarArgOffsetInParmArea(int32_t varArgOffsetInParmArea) {
    return _varArgOffsetInParmArea = varArgOffsetInParmArea;
  }
  int32_t getVarArgOffsetInParmArea() { return _varArgOffsetInParmArea; }

  int32_t setVarArgRegSaveAreaOffset(int32_t varArgRegSaveAreaOffset) {
    return _varArgRegSaveAreaOffset = varArgRegSaveAreaOffset;
  }
  ...
  virtual int32_t setParmOffsetInLocalArea(int32_t ParmOffsetInLocalArea) {
    return _parmOffsetInLocalArea = ParmOffsetInLocalArea;
  }
...
public:
  TR_S390SystemLinkage(TR::CodeGenerator *cg,
                       TR_S390LinkageConventions elc = TR_S390LinkageDefault,
                       TR_LinkageConventions lc = TR_System)
      : TR::Linkage(cg, elc, lc), _notifiedOfalloca(false),
        _notifiedOfDebugHooks(false), _GPRSaveMask(0), _FPRSaveMask(0),
        _ARSaveMask(0), _HPRSaveMask(0) {}
  ...
  virtual FrameType checkLeafRoutine(int32_t stackFrameSize,
  ...
  virtual TR::RealRegister *getNormalStackPointerRealRegister() {
    return getS390RealRegister(_normalStackPointerRegister);
  }
  ...
  virtual TR::RealRegister *getAlternateStackPointerRealRegister() {
    return getS390RealRegister(_alternateStackPointerRegister);
  }
  ...
  virtual TR::RealRegister::RegNum
  setDebugHooksRegister(TR::RealRegister::RegNum r) {
    return _debugHooksRegister = r;
  }
  virtual TR::RealRegister::RegNum getDebugHooksRegister() {
    return _debugHooksRegister;
  }
  virtual TR::RealRegister *getDebugHooksRealRegister() {
    return getS390RealRegister(_debugHooksRegister);
  }

  virtual TR::SymbolReference *
  createAutoMarkerSymbol(TR_S390AutoMarkers markerType);
  virtual void setAutoMarkerSymbols(TR_Array<TR::SymbolReference *> *symbols) {
    _autoMarkerSymbols = symbols;
  }
  virtual TR::SymbolReference *
  getAutoMarkerSymbol(TR_S390AutoMarkers markerType) {
    return _autoMarkerSymbols ? (*_autoMarkerSymbols)[markerType] : 0;
  }
  virtual void setAutoMarkerSymbolOffset(TR_S390AutoMarkers markerType,
                                         int32_t offset) {
    getAutoMarkerSymbol(markerType)
        ->getSymbol()
        ->castToAutoSymbol()
        ->setOffset(offset);
  }
  ...
  virtual TR::Instruction *getputFPRs(TR::InstOpCode::Mnemonic opcode,
                                      TR::Instruction *cursor, TR::Node *node,
                                      TR::RealRegister *spReg = 0);
  virtual TR::Instruction *getputARs(TR::InstOpCode::Mnemonic opcode,
                                     TR::Instruction *cursor, TR::Node *node,
                                     TR::RealRegister *spReg = 0);
  virtual TR::Instruction *getputHPRs(TR::InstOpCode::Mnemonic opcode,
                                      TR::Instruction *cursor, TR::Node *node,
                                      TR::RealRegister *spReg = 0);
};
