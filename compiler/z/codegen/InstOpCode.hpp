...
getMaskForBranchCondition(TR::InstOpCode::S390BranchCondition branchCond) {
  ...
  case TR::InstOpCode::COND_BNZRC:
    return 0x60;
  case TR::InstOpCode::COND_MASK7:
  case TR::InstOpCode::COND_BNZORC:
    return 0x70;
 ...
 * compare
 * operation is reversed.  For example "a > b" become "b < a", "a >= b" becomes
 * "b <= a"
 * basically, this corresponds to flipping the 2 middle bits of the branch
 * condition mask
