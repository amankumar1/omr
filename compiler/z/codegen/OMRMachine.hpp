...
class OMR_EXTENSIBLE Machine : public OMR::Machine {
  ...
  /** Used to keep track of blocked registers (HPR/GPR) that upgrades/spill's
   * etc should not use. Typical stores ~0-3 registers. */
...
public:
  ...
  bool isLegalEvenOddPair(TR::RealRegister *evenReg, TR::RealRegister *oddReg,
                          uint64_t availRegMask = 0x0000ffff);
  bool isLegalEvenOddRestrictedPair(TR::RealRegister *evenReg,
  ...
  void freeBestFPRegisterPair(TR::RealRegister **firstReg,
                              ...
                              TR::Instruction *currInst,
                              uint64_t availRegMask = 0x0000ffff);
  uint64_t filterColouredRegisterConflicts(TR::Register *targetRegister,
  ...
  // Used to keep track of blocked GPR's during HPR upgrades/spills/copies to
  // prevent clobbering
  ...
  void spillRegister(TR::Instruction *currentInstruction, TR::Register *virtReg,
                     uint32_t availHighWordRegMap = -1);
  ...
  void releaseGlobalRegister(int32_t globalRegisterTableIndex,
  ...
  setFirstGlobalAccessRegisterNumber(TR_GlobalRegisterNumber reg);
  ...
  TR_GlobalRegisterNumber
  setLastGlobalAccessRegisterNumber(TR_GlobalRegisterNumber reg);
  ...
  TR_GlobalRegisterNumber
  setLastGlobalHPRRegisterNumber(TR_GlobalRegisterNumber reg);
  ...
  TR_GlobalRegisterNumber
  setFirstGlobalHPRRegisterNumber(TR_GlobalRegisterNumber reg);
  ...
  TR::Register *
  getAccessRegisterFromGlobalRegisterNumber(TR_GlobalRegisterNumber reg);
