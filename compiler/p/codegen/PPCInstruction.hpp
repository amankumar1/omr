...
public:
  PPCAlignedLabelInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
                             TR::LabelSymbol *sym, int32_t align,
                             TR::CodeGenerator *codeGen)
      : PPCLabelInstruction(op, n, sym, codeGen), _alignment(align),
        _flipAlignmentDecision(false) {}
  ...
  PPCAlignedLabelInstruction(TR::InstOpCode::Mnemonic op, TR::Node *n,
      ...
      : PPCLabelInstruction(op, n, sym, precedingInstruction, codeGen),
        _alignment(align), _flipAlignmentDecision(false) {}
...
// across basic block
// boundaries then we use PPCControlFlowInstruction as a placeholder.  It
// contains a summary of
// register usage information and enough other information to generate the
// correct instruction
// sequence.
