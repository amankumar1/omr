...
inline void addDependency(TR::RegisterDependencyConditions *dep,
                          TR::Register *vreg, TR::RealRegister::RegNum rnum,
...
public:
  ...
  getOutgoingArgumentMemRef(int32_t argSize, TR::Register *argReg,
                            TR::InstOpCode::Mnemonic opCode,
                            TR_PPCMemoryArgument &memArg, uint32_t len);
  ...
  //
  virtual uintptr_t calculateActualParameterOffset(uintptr_t o,
  ...
  //
  virtual uintptr_t calculateParameterRegisterOffset(uintptr_t o,
                                                     TR::ParameterSymbol &p) {
    return o;
  }
