...
typedef enum {
  ...
  PPCOp_mftexasru, // Move from upper 32 bits of transaction exception and
  ...
  PPCOp_subfmeo_r, // Subtract from minus one extended setting overflow with
                   // record
  ...
  PPCOp_tabortdeqi_r,  // Transactional Memory abort dword if equal to immediate
                       // value
  PPCOp_tabortdge_r,   // Transactional Memory abort dword if greater than or
                       // equal to
  PPCOp_tabortdgei_r,  // Transactional Memory abort dword if greater than or
                       // equal to immediate
  PPCOp_tabortdgt_r,   // Transactional Memory abort dword if greater than
  PPCOp_tabortdgti_r,  // Transactional Memory abort dword if greater than
                       // immediate
  PPCOp_tabortdle_r,   // Transactional Memory abort dword if less than or equal
                       // to
  PPCOp_tabortdlei_r,  // Transactional Memory abort dword if less than or equal
                       // to immediate
  PPCOp_tabortdlge_r,  // Transactional Memory abort dword if logically greater
                       // than or equal to
  PPCOp_tabortdlgei_r, // Transactional Memory abort dword if logically greater
                       // than or equal to immediate
  PPCOp_tabortdlgt_r,  // Transactional Memory abort dword if logically greater
                       // than
  PPCOp_tabortdlgti_r, // Transactional Memory abort dword if logically greater
                       // than immediate
  PPCOp_tabortdlle_r, // Transactional Memory abort dword if logically less than
                      // or equal to
  PPCOp_tabortdllei_r, // Transactional Memory abort dword if logically less
                       // than or equal to immediate
  PPCOp_tabortdllt_r, // Transactional Memory abort dword if logically less than
  PPCOp_tabortdllti_r, // Transactional Memory abort dword if logically less
                       // than immediate
  ...
  PPCOp_tabortdneqi_r, // Transactional Memory abort dword if not equal to
                       // immediate
  ...
  PPCOp_tabortwgei_r,  // Transactional Memory abort if greater than or equal to
                       // immediate
  ...
  PPCOp_tabortwlei_r,  // Transactional Memory abort if less than or equal to
                       // immediate
  PPCOp_tabortwlge_r, // Transactional Memory abort if logically greater than or
                      // equal to
  PPCOp_tabortwlgei_r, // Transactional Memory abort if logically greater than
                       // or equal to immediate
  PPCOp_tabortwlgt_r,  // Transactional Memory abort if logically greater than
  PPCOp_tabortwlgti_r, // Transactional Memory abort if logically greater than
                       // immediate
  PPCOp_tabortwlle_r,  // Transactional Memory abort if logically less than or
                       // equal to
  PPCOp_tabortwllei_r, // Transactional Memory abort if logically less than or
                       // equal to immediate
  PPCOp_tabortwllt_r,  // Transactional Memory abort if logically less than
  PPCOp_tabortwllti_r, // Transactional Memory abort if logically less than
                       // immediate
  ...
  PPCOp_tdlgei, // Trap dword if logically greater than or equal to immediate
                // value
  ...
  PPCOp_twlgei, // Trap word if logically greater than or equal to immediate
                // value
  ...
  PPCOp_flcmpl,     // compare float and set result
                    // -1(less,unordered),0(equal),1(greater)
  PPCOp_flcmpg,     // compare float and set result
  ...
  PPCOp_xscpsgndp,  // VSX Scalar Copy Sign Double-Precision , For VSR Copy
                    // register
  PPCOp_xscvdpsxds, // VSX Scalar Convert Double-Precision to Signed Integer
                    // Doubleword Saturate
  PPCOp_xscvdpsxws, // VSX Scalar Convert Double-Precision to Signed Integer
                    // Word Saturate
  ...
  PPCOp_xsnmsubadp, // VSX Scalar Negative Multiply-Subtract Type A
                    // Double-Precision
  PPCOp_xsnmsubmdp, // VSX Scalar Negative Multiply-Subtract Type M
                    // Double-Precision
  PPCOp_xsrdpic,    // VSX Scalar Round to Double-Precision exact using Current
                    // rounding mode
  PPCOp_xsredp,     // VSX Scalar Reciprocal Estimate Double-Precision
  PPCOp_xsrsqrtedp, // VSX Scalar Reciprocal Square Root Estimate
                    // Double-Precision
  ...
  PPCOp_xscvsxddp,  // VSX Scalar Convert Signed Integer Doubleword to
                    // Double-Precision
  PPCOp_xscvdpsp,   // VSX Scalar Convert From Double-Precision to
                    // Single-Precision
  ...
  PPCOp_xvcmpgedp,   // VSX Vector Compare Greater Than Or Equal To
                     // Double-Precision
  PPCOp_xvcmpgedp_r, // VSX Vector Compare Greater Than Or Equal To
                     // Double-Precision
  ...
  PPCOp_xvnmsubadp,  // VSX Vector Negative Multiply-Subtract Type-A
                     // Double-Precision
  PPCOp_xvnmsubmdp,  // VSX Vector Negative Multiply-Subtract Type-M
                     // Double-Precision
  ...
  PPCOp_xscvdpspn, // Scalar Convert Double-Precision to Single-Precision format
                   // Non-signalling
  PPCOp_xscvdpuxds, // Scalar Convert Double-Precision to Unsigned Fixed-Point
                    // Doubleword Saturate
  PPCOp_xscvdpuxws, // Scalar Convert Double-Precision to Unsigned Fixed-Point
                    // Word Saturate
  PPCOp_xscvspdp,   // Scalar Convert Single-Precision to Double-Precision (p=1)
  PPCOp_xscvspdpn,  // Convert Single-Precision to Double-Precision format
                    // Non-signalling
  PPCOp_xscvsxdsp,  // Scalar Convert Signed Fixed-Point Doubleword to
                    // Single-Precision
  PPCOp_xscvuxddp,  // Scalar Convert Unsigned Fixed-Point Doubleword to
                    // Double-Precision
  PPCOp_xscvuxdsp,  // Scalar Convert Unsigned Fixed-Point Doubleword to
                    // Single-Precision
  ...
  PPCOp_xvcmpgesp_r, // Vector Compare Greater Than or Equal To Single-Precision
                     // & record CR6
  PPCOp_xvcmpgtsp,   // Vector Compare Greater Than Single-Precision
  PPCOp_xvcmpgtsp_r, // Vector Compare Greater Than Single-Precision & record
                     // CR6
  ...
  PPCOp_xvcvdpsxds,  // Vector Convert Double-Precision to Signed Fixed-Point
                     // Doubleword Saturate
  PPCOp_xvcvdpsxws,  // Vector Convert Double-Precision to Signed Fixed-Point
                     // Word Saturate
  PPCOp_xvcvdpuxds,  // Vector Convert Double-Precision to Unsigned Fixed-Point
                     // Doubleword Saturate
  PPCOp_xvcvdpuxws,  // Vector Convert Double-Precision to Unsigned Fixed-Point
                     // Word Saturate
  PPCOp_xvcvspdp,    // Vector Convert Single-Precision to Double-Precision
  PPCOp_xvcvspsxds,  // Vector Convert Single-Precision to Signed Fixed-Point
                     // Doubleword Saturate
  PPCOp_xvcvspsxws,  // Vector Convert Single-Precision to Signed Fixed-Point
                     // Word Saturate
  PPCOp_xvcvspuxds,  // Vector Convert Single-Precision to Unsigned Fixed-Point
                     // Doubleword Saturate
  PPCOp_xvcvspuxws,  // Vector Convert Single-Precision to Unsigned Fixed-Point
                     // Word Saturate
  PPCOp_xvcvsxddp,   // Vector Convert Signed Fixed-Point Doubleword to
                     // Double-Precision
  PPCOp_xvcvsxdsp,   // Vector Convert Signed Fixed-Point Doubleword to
                     // Single-Precision
  ...
  PPCOp_xvcvuxddp, // Vector Convert Unsigned Fixed-Point Doubleword to
                   // Double-Precision
  PPCOp_xvcvuxdsp, // Vector Convert Unsigned Fixed-Point Doubleword to
                   // Single-Precision
  PPCOp_xvcvuxwdp, // Vector Convert Unsigned Fixed-Point Word to
                   // Double-Precision
  PPCOp_xvcvuxwsp, // Vector Convert Unsigned Fixed-Point Word to
                   // Single-Precision
  ...
  PPCOp_xvrdpic,    // Vector Round to Double-Precision Integer using Current
                    // rounding mode
  ...
  PPCOp_xvrspic,    // Vector Round to Single-Precision Integer using Current
                    // rounding mode
