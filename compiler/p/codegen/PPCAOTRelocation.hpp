...
public:
  ...
  TR_PPCRelocation(TR::Instruction *src, uint8_t *trg,
...
public:
  TR_PPCPairedRelocation(TR::Instruction *src1, TR::Instruction *src2,
...
// instructions
// with the absolute address of a label (extended to 64bit as well).  For
// example:
//   lis  gr3, addr_hi
...
public:
  TR_PPCPairedLabelAbsoluteRelocation(TR::Instruction *src1,
      ...
      : TR_LabelRelocation(0, label), _instr1(src1), _instr2(src2),
