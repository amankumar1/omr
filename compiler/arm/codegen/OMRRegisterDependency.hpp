...
public:
  ...
  void addPreCondition(TR::Register *vr, OMR::ARM::RealRegister::RegNum rr,
  ...
  void addPostCondition(TR::Register *vr, OMR::ARM::RealRegister::RegNum rr,
                        uint8_t flag = UsesDependentRegister) {
