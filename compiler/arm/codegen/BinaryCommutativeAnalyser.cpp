...
void TR_ARMBinaryCommutativeAnalyser::genericAnalyser(
  ...
  if (getOpReg1Reg2()) {
    ...
    //      TR_ARMMemoryReference(secondChild);
    //      new TR::ARMRegMemInstruction(memToRegOpCode, firstRegister, tempMR);
    //      tempMR->decNodeReferenceCounts();
    //      root->setRegister(firstRegister);
  } else {
    //      TR_ARMMemoryReference *tempMR = new
    //      TR_ARMMemoryReference(firstChild);
    //      new TR::ARMRegMemInstruction(memToRegOpCode, secondRegister,
    //      tempMR);
    //      tempMR->decNodeReferenceCounts();
    //      root->setRegister(secondRegister);
    //      notReversedOperands();
...
void TR_ARMBinaryCommutativeAnalyser::genericLongAnalyser(
  ...
  if (getOpReg1Reg2()) {
    ...
    //      TR::Register *tempReg =
    //      root->setRegister(cg()->allocateRegisterPair());
    ...
    //      TR_ARMMemoryReference(secondChild);
    //      TR_ARMMemoryReference *highMR = new TR_ARMMemoryReference(*lowMR,
    //      4);
...
void TR_ARMBinaryCommutativeAnalyser::longAddAnalyser(TR::Node *root) {
  ...
  if (getOpReg1Reg2()) {
    ...
    //      firstRegister->getLowOrder(), secondRegister->getLowOrder());
    //      new TR::ARMRegRegInstruction(ADC4RegReg,
    //      firstRegister->getHighOrder(), secondRegister->getHighOrder());
    //      root->setRegister(firstRegister);
  } else if (getOpReg2Reg1()) {
    //      new TR::ARMRegRegInstruction(ADD4RegReg,
    //      secondRegister->getLowOrder(), firstRegister->getLowOrder());
    //      new TR::ARMRegRegInstruction(ADC4RegReg,
    //      secondRegister->getHighOrder(), firstRegister->getHighOrder());
    //      root->setRegister(secondRegister);
    //      notReversedOperands();
  } else if (getCopyRegs()) {
    ...
    //      firstRegister->getLowOrder());
    //      new TR::ARMRegRegInstruction(MOV4RegReg, highRegister,
    //      firstRegister->getHighOrder());
    //      new TR::ARMRegRegInstruction(ADD4RegReg, tempReg->getLowOrder(),
    //      secondRegister->getLowOrder());
    //      new TR::ARMRegRegInstruction(ADC4RegReg, tempReg->getHighOrder(),
    //      secondRegister->getHighOrder());
    //      root->setRegister(tempReg);
  } else if (getOpReg1Mem2()) {
    //      TR_ARMMemoryReference *lowMR  = new
    ...
    //      TR_ARMMemoryReference *highMR = new TR_ARMMemoryReference(*lowMR,
    //      4);
    //      new TR::ARMRegMemInstruction(ADD4RegMem,
    //      firstRegister->getLowOrder(), lowMR);
    //      new TR::ARMRegMemInstruction(ADC4RegMem,
    ...
    //      4);
    //      new TR::ARMRegMemInstruction(ADD4RegMem,
    //      secondRegister->getLowOrder(), lowMR);
    //      new TR::ARMRegMemInstruction(ADC4RegMem,
