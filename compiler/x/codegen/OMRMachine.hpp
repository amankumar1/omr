...
public:
  ...
  TR::RealRegister **setRegisterFile(TR::RealRegister **r) {
    return _registerFile = r;
  }
...
protected:
  Machine(uint8_t numIntRegs, uint8_t numFPRegs, TR::CodeGenerator *cg,
          TR::RealRegister **registerFile, TR::Register **registerAssociations,
          uint8_t numGlobalGPRs, uint8_t numGlobal8BitGPRs,
          uint8_t numGlobalFPRs, TR::Register **xmmGlobalRegisters,
