...
public:
  ...
  static TR::Register *ifInstanceOfHelper(TR::Node *node,
                                          TR::CodeGenerator *cg);
  ...
  static TR::Register *arraytranslateAndTestEvaluator(TR::Node *node,
                                                      TR::CodeGenerator *cg);
  static TR::Register *encodeUTF16Evaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  ...
  static TR::Register *OverflowCHKEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  static TR::Register *compressStringEvaluator(TR::Node *node,
                                               TR::CodeGenerator *cg,
                                               bool japaneseMethod);
  static TR::Register *compressStringNoCheckEvaluator(TR::Node *node,
                                                      TR::CodeGenerator *cg,
                                                      bool japaneseMethod);
  static TR::Register *andORStringEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  ...
  static TR::Register *VMmergenewEvaluator(TR::Node *node,
                                           TR::CodeGenerator *cg);
  static TR::Register *
  VMarrayStoreCheckArrayCopyEvaluator(TR::Node *node, TR::CodeGenerator *cg);
  static bool VMinlineCallEvaluator(TR::Node *node, bool isIndirect,
                                    TR::CodeGenerator *cg);
  static TR::Register *VMAESHelperEvaluator(TR::Node *node,
                                            TR::CodeGenerator *cg);
  ...
  static bool genNullTestSequence(TR::Node *node, TR::Register *opReg,
                                  ...
                                  TR::CodeGenerator *cg);
  static TR::Register *VMifArrayCmpEvaluator(TR::Node *node,
                                             TR::CodeGenerator *cg);
  ...
  static TR::Register *constLengthArrayCopyEvaluator(TR::Node *node,
                                                     TR::CodeGenerator *cg);
  ...
  // correct to mask int rotates by 0x1f
  // as the part of the rotate above 31 is a nop essentially and should be
  // masked off
...
protected:
  ...
  static TR::Register *SSE2ArraycmpLenEvaluator(TR::Node *node,
                                                TR::CodeGenerator *cg);
  static TR::Register *SSE2IfArraycmpEvaluator(TR::Node *node,
