...
public:
  ...
  // data snippet are mutually exclusive for
  ...
  void setSIBPresent(uint8_t *modRM) { *modRM |= IA32SIBPresent; }
...
TR::MemoryReference *generateX86MemoryReference(TR::SymbolReference *,
                                                intptrj_t,
                                                TR::CodeGenerator *cg);
TR::MemoryReference *generateX86MemoryReference(TR::IA32DataSnippet *,
                                                TR::CodeGenerator *cg);
