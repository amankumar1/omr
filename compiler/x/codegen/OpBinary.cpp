...
const TR_X86OpCode::TR_OpCodeBinaryEntry
    TR_X86OpCode::_binaryEncodings[IA32NumOpCodes] = {
        ...
        {0x0f, 0xb0, 0x00, 3}, // LCMPXCHG1MemReg NOTE: The lock prefix is added
                               // at binary encoding time
