...
OMR::X86::RegisterIterator::RegisterIterator(TR::Machine *machine,
...
TR::Register *OMR::X86::RegisterIterator::getFirst() {
  return _machine->getX86RealRegister(
      (TR::RealRegister::RegNum)(_cursor = _firstRegIndex));
}

TR::Register *OMR::X86::RegisterIterator::getCurrent() {
  return _machine->getX86RealRegister((TR::RealRegister::RegNum)_cursor);
}

TR::Register *OMR::X86::RegisterIterator::getNext() {
  return _cursor == _lastRegIndex ? NULL
                                  : _machine->getX86RealRegister(
