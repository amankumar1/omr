...
typedef enum {
  ...
  ADC8AccImm4,  // Add qword with Carry RAX, Immediate sign-extended dword
                // (AMD64)
  ...
  ADC8RegImm4,  // Add qword with Carry Register, Immediate sign-extended dword
                // (AMD64)
  ADC4RegImms,  // Add dword with Carry Register, Immediate sign-extended byte
  ADC8RegImms,  // Add qword with Carry Register, Immediate sign-extended byte
                // (AMD64)
  ...
  ADC8MemImm4,  // Add qword with Carry Memory, Immediate sign-extended dword
                // (AMD64)
  ADC4MemImms,  // Add dword with Carry Memory, Immediate sign extended byte
  ADC8MemImms,  // Add qword with Carry Memory, Immediate sign extended byte
                // (AMD64)
  ...
  AND8RegImm4,  // Logical And qword Register, Immediate sign-extended dword
                // (AMD64)
  AND4RegImms,  // Logical And dword Register, Immediate sign-extended byte
  AND8RegImms,  // Logical And qword Register, Immediate sign-extended byte
                // (AMD64)
  ...
  AND8MemImm4,  // Logical And qword Memory, Immediate sign-extended dword
                // (AMD64)
  ...
  CALLREXImm4, // Call near, displacement relative to next instruction, force
               // Rex prefix (AMD64)
  ...
  CMOVA4RegMem, // Conditional dword move if above (unsigned greater than) (CF=0
                // and ZF=0)
  ...
  CMPXCHG8BMem,    // Compare and Exchange qword Memory with EDX:EAX and ECX:EBX
                   // register pairs (IA32 only)
  CMPXCHG16BMem,   // Compare and Exchange qword Memory with RDX:RAX and RCX:RBX
                   // register pairs (AMD64)
  ...
  LCMPXCHG8BMem,   // Locked Compare and Exchange qword Memory with EDX:EAX and
                   // ECX:EBX register pairs (IA32 only)
  LCMPXCHG16BMem,  // Locked Compare and Exchange qword Memory with RDX:RAX and
                   // RCX:RBX register pairs (AMD64)
  XALCMPXCHG8MemReg, // Xacquire Locked Compare and Exchange qword Memory,
                     // Register (AMD64)
  XACMPXCHG8MemReg,  // Xacquire Compare and Exchange qword Memory, Register
                     // (AMD64)
  XALCMPXCHG4MemReg, // Xacquire Locked Compare and Exchange dword Memory,
                     // Register
  XACMPXCHG4MemReg,  // Xacquire Compare and Exchange dword Memory, Register
  CVTSI2SSRegReg4,   // Signed INT32 to Scalar Single-FP Conversion  Register,
                     // Register
  CVTSI2SSRegReg8,   // Signed INT64 to Scalar Single-FP Conversion  Register,
                     // Register (AMD64)
  CVTSI2SSRegMem,    // Signed INT32 to Scalar Single-FP Conversion  Register,
                     // Memory TODO:AMD64: "...Mem4"
  CVTSI2SSRegMem8,   // Signed INT64 to Scalar Single-FP Conversion  Register,
                     // Memory (AMD64)
  CVTSI2SDRegReg4,   // Signed INT32 to Scalar Double-FP Conversion  Register,
                     // Register
  CVTSI2SDRegReg8,   // Signed INT64 to Scalar Double-FP Conversion  Register,
                     // Register (AMD64)
  CVTSI2SDRegMem,    // Signed INT32 to Scalar Double-FP Conversion  Register,
                     // Memory TODO:AMD64: "...Mem4"
  CVTSI2SDRegMem8,   // Signed INT64 to Scalar Double-FP Conversion  Register,
                     // Memory (AMD64)
  CVTTSS2SIReg4Reg,  // Scalar Single-FP to Signed INT32 Conversion (Truncate)
                     // Register, Register
  CVTTSS2SIReg8Reg,  // Scalar Single-FP to Signed INT64 Conversion (Truncate)
                     // Register, Register (AMD64)
  CVTTSS2SIReg4Mem,  // Scalar Single-FP to Signed INT32 Conversion (Truncate)
                     // Register, Memory
  CVTTSS2SIReg8Mem,  // Scalar Single-FP to Signed INT64 Conversion (Truncate)
                     // Register, Memory (AMD64)
  CVTTSD2SIReg4Reg,  // Scalar Double-FP to Signed INT32 Conversion (Truncate)
                     // Register, Register
  CVTTSD2SIReg8Reg,  // Scalar Double-FP to Signed INT64 Conversion (Truncate)
                     // Register, Register (AMD64)
  CVTTSD2SIReg4Mem,  // Scalar Double-FP to Signed INT32 Conversion (Truncate)
                     // Register, Memory
  CVTTSD2SIReg8Mem,  // Scalar Double-FP to Signed INT64 Conversion (Truncate)
                     // Register, Memory (AMD64)
  CVTSS2SDRegReg, // Scalar Single-FP to Scalar Double-FP Conversion  Register,
                  // Register
  CVTSS2SDRegMem, // Scalar Single-FP to Scalar Double-FP Conversion  Register,
                  // Memory
  CVTSD2SSRegReg, // Scalar Double-FP to Scalar Single-FP Conversion  Register,
                  // Register
  CVTSD2SSRegMem, // Scalar Double-FP to Scalar Single-FP Conversion  Register,
                  // Memory
  ...
  FIDIVRRegMem,   // Float Reverse Divide by 32-bit integer fRegister, Memory
                  // dword
  DIDIVRRegMem,   // Double Reverse Divide by 32-bit integer dRegister, Memory
                  // dword
  FSDIVRRegMem, // Float Reverse Divide by 16-bit integer fRegister, Memory word
  DSDIVRRegMem, // Double Reverse Divide by 16-bit integer dRegister, Memory
                // word
  ...
  FISTPMem,   // Store and Pop float Register converted to 32-bit integer Memory
              // dword
  DISTPMem, // Store and Pop double Register converted to 32-bit integer Memory
            // dword
  FLSTPMem, // Store and Pop float Register converted to 64-bit integer Memory
            // qword
  DLSTPMem, // Store and Pop double Register converted to 64-bit integer Memory
            // qword
  ...
  FSSTPMem,   // Store and Pop float Register converted to 16-bit integer Memory
              // word
  DSSTPMem,  // Store and Pop double Register converted to 16-bit integer Memory
             // word
  ...
  FNCLEX,      // Clear FP exception flags without checking for pending unmasked
               // exceptions
  ...
  FISUBRRegMem, // Float Reverse Subtract by 32-bit integer fRegister, Memory
                // dword
  DISUBRRegMem, // Double Reverse Subtract by 32-bit integer dRegister, Memory
                // dword
  FSSUBRRegMem, // Float Reverse Subtract by 16-bit integer fRegister, Memory
                // word
  DSSUBRRegMem, // Double Reverse Subtract by 16-bit integer dRegister, Memory
                // word
  ...
  FCOMIPReg,    // Float/Double Compare Register-Register, Pop Register, and set
                // EFLAGS
  FYL2X,        // Double Compute y * LOG2(x)
  UCOMISSRegReg, // Unordered Compare Scalar Single-FP Register, Register and
                 // set EFLAGS
  UCOMISSRegMem, // Unordered Compare Scalar Single-FP Register, Memory and set
                 // EFLAGS
  UCOMISDRegReg, // Unordered Compare Scalar Double-FP Register, Register and
                 // set EFLAGS
  UCOMISDRegMem, // Unordered Compare Scalar Double-FP Register, Memory and set
                 // EFLAGS
  FXCHReg,       // Float/Double exchange Register, Register
  IDIV1AccReg,   // Signed Divide word by byte AX, Register (AL=Quotient,
                 // AH=Remainder)
  IDIV2AccReg,   // Signed Divide dword by word DX:AX, Register (AX=Quotient,
                 // DX=Remainder)
  IDIV4AccReg,   // Signed Divide qword by word EDX:EAX, Register (EAX=Quotient,
                 // EDX=Remainder)
  IDIV8AccReg,   // Signed Divide qword by word RDX:RAX, Register (RAX=Quotient,
                 // RDX=Remainder) (AMD64)
  DIV4AccReg,  // Unsigned Divide qword by word EDX:EAX, Register (EAX=Quotient,
               // EDX=Remainder)
  DIV8AccReg,  // Unsigned Divide qword by word RDX:RAX, Register (RAX=Quotient,
               // RDX=Remainder) (AMD64)
  IDIV1AccMem, // Signed Divide word by byte AX, Memory (AL=Quotient,
               // AH=Remainder)
  IDIV2AccMem, // Signed Divide dword by word DX:AX, Memory (AX=Quotient,
               // DX=Remainder)
  IDIV4AccMem, // Signed Divide qword by word EDX:EAX, Memory (EAX=Quotient,
               // EDX=Remainder)
  IDIV8AccMem, // Signed Divide qword by word RDX:RAX, Memory (RAX=Quotient,
               // RDX=Remainder) (AMD64)
  DIV4AccMem,  // Signed Divide qword by word EDX:EAX, Memory (EAX=Quotient,
               // EDX=Remainder)
  DIV8AccMem,  // Signed Divide qword by word RDX:RAX, Memory (RAX=Quotient,
               // RDX=Remainder) (AMD64)
  ...
  IMUL2RegRegImms, // Signed word Multiply Register1, Register2, Signed-Extended
                   // Immediate byte
  IMUL4RegRegImm4, // Signed dword Multiply Register1, Register2, Immediate
                   // dword
  IMUL8RegRegImm4, // Signed qword Multiply Register1, Register2, Immediate
                   // sign-extended dword (AMD64)
  IMUL4RegRegImms, // Signed dword Multiply Register1, Register2,
                   // Signed-Extended Immediate byte
  IMUL8RegRegImms, // Signed qword Multiply Register1, Register2,
                   // Signed-Extended Immediate byte (AMD64)
  IMUL2RegMemImm2, // Signed word Multiply Register, Memory word, Immediate word
  IMUL2RegMemImms, // Signed word Multiply Register, Memory word,
                   // Signed-Extended Immediate byte
  IMUL4RegMemImm4, // Signed dword Multiply Register, Memory dword, Immediate
                   // dword
  IMUL8RegMemImm4, // Signed qword Multiply Register, Memory qword, Immediate
                   // sign-extended dword (AMD64)
  IMUL4RegMemImms, // Signed dword Multiply Register, Memory dword,
                   // Signed-Extended Immediate byte
  IMUL8RegMemImms, // Signed qword Multiply Register, Memory qword,
                   // Signed-Extended Immediate byte (AMD64)
  ...
  XRS8MemImm4,   // Xrelease Store Immediate sign-extended dword to Memory qword
                 // (AMD64)
  ...
  CMOVG8RegReg,  // Conditional greater than move qword Register, Register
                 // (AMD64)
  CMOVL4RegReg,  // Conditional greater than move dword Register, Register
  CMOVL8RegReg,  // Conditional greater than move qword Register, Register
                 // (AMD64)
  CMOVE4RegReg,  // Conditional equal (zero) move dword Register, Register
  CMOVE8RegReg,  // Conditional equal (zero) move dword Register, Register
                 // (AMD64)
  CMOVNE4RegReg, // Conditional not-equal (non-zero) move dword Register,
                 // Register
  CMOVNE8RegReg, // Conditional not-equal (non-zero) move dword Register,
                 // Register (AMD64)
  ...
  MOV8RegImm4,   // Move Immediate dword to qword Register (note: sign-extended)
                 // (AMD64)
  MOV8RegImm64,  // Move Immediate qword to qword Register (AMD64)
  MOVLPDRegMem,  // Load quadword into low order 64 bits of XMM reg (no zero
  ...
  MOVSXReg8Reg4, // Move Sign-Extended dword Register4 to qword Register8
                 // (AMD64)
  ...
  OR8RegImm4,    // Logical Or qword Register, Immediate sign-extended dword
                 // (AMD64)
  ...
  LOR4MemImms, // Locked Logical Or dword Memory, Immediate sign extended byte
               // (used for memory fence)
  ...
  PMOVMSKB4RegReg,  // Move the leading bit of each byte from source to
                    // destination
  ...
  PSHUFDRegRegImm1, // Shuffle Packed Doublewords Register, Register by
                    // Immediate config
  PSHUFDRegMemImm1, // Shuffle Packed Doublewords Register, Memory by Immediate
                    // config
  ...
  REPSTOSD, // Store ECX copies of EAX to memory at [EDI] TODO:AMD64: Actually
            // RCX copies
  ...
  SHR8RegImm1, // Shift Right Logical qword Register by Immediate byte # bits
               // (AMD64)
  ...
  SHR8MemImm1, // Shift Right Logical Memory qword by Immediate byte # bits
               // (AMD64)
  ...
  SAR8RegImm1, // Shift Right Arithmetic qword Register by Immediate byte # bits
               // (AMD64)
  ...
  SAR8MemImm1, // Shift Right Arithmetic Memory qword by Immediate byte # bits
               // (AMD64)
  ...
  SBB8AccImm4, // Subtract qword with Borrow RAX, Immediate sign-extended dword
               // (AMD64)
  ...
  SBB2RegImms, // Subtract word with Borrow  Register, Immediate sign-extended
               // byte
  SBB4RegImm4, // Subtract dword with Borrow Register, Immediate dword
  SBB8RegImm4, // Subtract qword with Borrow Register, Immediate sign-extended
               // dword (AMD64)
  SBB4RegImms, // Subtract dword with Borrow Register, Immediate sign-extended
               // byte
  SBB8RegImms, // Subtract qword with Borrow Register, Immediate sign-extended
               // byte (AMD64)
  SBB1MemImm1, // Subtract byte with Borrow  Memory, Immediate byte
  SBB2MemImm2, // Subtract word with Borrow  Memory, Immediate word
  SBB2MemImms, // Subtract word with Borrow  Memory, Immediate sign extended
               // byte
  SBB4MemImm4, // Subtract dword with Borrow Memory, Immediate dword
  SBB8MemImm4, // Subtract qword with Borrow Memory, Immediate sign-extended
               // dword (AMD64)
  SBB4MemImms, // Subtract dword with Borrow Memory, Immediate sign extended
               // byte
  SBB8MemImms, // Subtract qword with Borrow Memory, Immediate sign extended
               // byte (AMD64)
  ...
  SHLD4RegRegImm1, // Shift Left Double Precision Register, Register by
                   // Immediate count
  SHLD4RegRegCL,   // Shift Left Double Precision Register, Register by CL count
  SHLD4MemRegImm1, // Shift Left Double Precision Memory, Register by Immediate
                   // count
  SHLD4MemRegCL,   // Shift Left Double Precision Memory, Register by CL count
  SHRD4RegRegImm1, // Shift Right Double Precision Register, Register by
                   // Immediate count
  SHRD4RegRegCL, // Shift Right Double Precision Register, Register by CL count
  SHRD4MemRegImm1, // Shift Right Double Precision Memory, Register by Immediate
                   // count
  ...
  XOR8RegImm4,  // Exclusive Or qword Register, Immediate sign-extended dword
                // (AMD64)
  XOR4RegImms,  // Exclusive Or dword Register, Immediate sign-extended byte
  XOR8RegImms,  // Exclusive Or qword Register, Immediate sign-extended byte
                // (AMD64)
  ...
  XOR8MemImm4,  // Exclusive Or qword Memory, Immediate sign-extended dword
                // (AMD64)
  XOR4MemImms,  // Exclusive Or dword Memory, Immediate sign extended byte
  XOR8MemImms,  // Exclusive Or qword Memory, Immediate sign extended byte
                // (AMD64)
  ...
  FCMPEVAL, // Instruction selection of FP comparisons at register assignment
            // time
  ...
  ReturnMarker,    // Return Marker for linkages that do not end with a RET
                   // instruction
...
//
inline TR_X86OpCodes BSFRegReg(bool is64Bit) {
  return is64Bit ? BSF8RegReg : BSF4RegReg;
}
inline TR_X86OpCodes BSWAPReg(bool is64Bit) {
  return is64Bit ? BSWAP8Reg : BSWAP4Reg;
}
inline TR_X86OpCodes BSRRegReg(bool is64Bit) {
  return is64Bit ? BSR8RegReg : BSR4RegReg;
}
inline TR_X86OpCodes CMOVERegMem(bool is64Bit) {
  return is64Bit ? CMOVE8RegMem : CMOVE4RegMem;
}
inline TR_X86OpCodes CMOVERegReg(bool is64Bit) {
  return is64Bit ? CMOVE8RegReg : CMOVE4RegReg;
}
inline TR_X86OpCodes CMOVNERegMem(bool is64Bit) {
  return is64Bit ? CMOVNE8RegMem : CMOVNE4RegMem;
}
inline TR_X86OpCodes CMOVNERegReg(bool is64Bit) {
  return is64Bit ? CMOVNE8RegReg : CMOVNE4RegReg;
}
inline TR_X86OpCodes CMPRegImms(bool is64Bit) {
  return is64Bit ? CMP8RegImms : CMP4RegImms;
}
inline TR_X86OpCodes CMPRegImm4(bool is64Bit) {
  return is64Bit ? CMP8RegImm4 : CMP4RegImm4;
}
inline TR_X86OpCodes CMPMemImms(bool is64Bit) {
  return is64Bit ? CMP8MemImms : CMP4MemImms;
}
inline TR_X86OpCodes CMPMemImm4(bool is64Bit) {
  return is64Bit ? CMP8MemImm4 : CMP4MemImm4;
}
inline TR_X86OpCodes MOVRegReg(bool is64Bit) {
  return is64Bit ? MOV8RegReg : MOV4RegReg;
}
inline TR_X86OpCodes LEARegMem(bool is64Bit) {
  return is64Bit ? LEA8RegMem : LEA4RegMem;
}
inline TR_X86OpCodes LRegMem(bool is64Bit) {
  return is64Bit ? L8RegMem : L4RegMem;
}
inline TR_X86OpCodes SMemReg(bool is64Bit) {
  return is64Bit ? S8MemReg : S4MemReg;
}
inline TR_X86OpCodes SMemImm4(bool is64Bit) {
  return is64Bit ? S8MemImm4 : S4MemImm4;
}
inline TR_X86OpCodes XRSMemImm4(bool is64Bit) {
  return is64Bit ? XRS8MemImm4 : XRS4MemImm4;
}
inline TR_X86OpCodes XCHGRegReg(bool is64Bit) {
  return is64Bit ? XCHG8RegReg : XCHG4RegReg;
}
inline TR_X86OpCodes NEGReg(bool is64Bit) {
  return is64Bit ? NEG8Reg : NEG4Reg;
}
inline TR_X86OpCodes IMULRegReg(bool is64Bit) {
  return is64Bit ? IMUL8RegReg : IMUL4RegReg;
}
inline TR_X86OpCodes IMULRegMem(bool is64Bit) {
  return is64Bit ? IMUL8RegMem : IMUL4RegMem;
}
inline TR_X86OpCodes IMULRegRegImms(bool is64Bit) {
  return is64Bit ? IMUL8RegRegImms : IMUL4RegRegImms;
}
inline TR_X86OpCodes IMULRegRegImm4(bool is64Bit) {
  return is64Bit ? IMUL8RegRegImm4 : IMUL4RegRegImm4;
}
inline TR_X86OpCodes IMULRegMemImms(bool is64Bit) {
  return is64Bit ? IMUL8RegMemImms : IMUL4RegMemImms;
}
inline TR_X86OpCodes IMULRegMemImm4(bool is64Bit) {
  return is64Bit ? IMUL8RegMemImm4 : IMUL4RegMemImm4;
}
inline TR_X86OpCodes INCMem(bool is64Bit) {
  return is64Bit ? INC8Mem : INC4Mem;
}
inline TR_X86OpCodes INCReg(bool is64Bit) {
  return is64Bit ? INC8Reg : INC4Reg;
}
inline TR_X86OpCodes DECMem(bool is64Bit) {
  return is64Bit ? DEC8Mem : DEC4Mem;
}
inline TR_X86OpCodes DECReg(bool is64Bit) {
  return is64Bit ? DEC8Reg : DEC4Reg;
}
inline TR_X86OpCodes ADDMemImms(bool is64Bit) {
  return is64Bit ? ADD8MemImms : ADD4MemImms;
}
inline TR_X86OpCodes ADDRegImms(bool is64Bit) {
  return is64Bit ? ADD8RegImms : ADD4RegImms;
}
inline TR_X86OpCodes ADDRegImm4(bool is64Bit) {
  return is64Bit ? ADD8RegImm4 : ADD4RegImm4;
}
inline TR_X86OpCodes ADCMemImms(bool is64Bit) {
  return is64Bit ? ADC8MemImms : ADC4MemImms;
}
inline TR_X86OpCodes ADCRegImms(bool is64Bit) {
  return is64Bit ? ADC8RegImms : ADC4RegImms;
}
inline TR_X86OpCodes ADCRegImm4(bool is64Bit) {
  return is64Bit ? ADC8RegImm4 : ADC4RegImm4;
}
inline TR_X86OpCodes SUBMemImms(bool is64Bit) {
  return is64Bit ? SUB8MemImms : SUB4MemImms;
}
inline TR_X86OpCodes SUBRegImms(bool is64Bit) {
  return is64Bit ? SUB8RegImms : SUB4RegImms;
}
inline TR_X86OpCodes SBBMemImms(bool is64Bit) {
  return is64Bit ? SBB8MemImms : SBB4MemImms;
}
inline TR_X86OpCodes SBBRegImms(bool is64Bit) {
  return is64Bit ? SBB8RegImms : SBB4RegImms;
}
inline TR_X86OpCodes ADDMemImm4(bool is64Bit) {
  return is64Bit ? ADD8MemImm4 : ADD4MemImm4;
}
inline TR_X86OpCodes ADDMemReg(bool is64Bit) {
  return is64Bit ? ADD8MemReg : ADD4MemReg;
}
inline TR_X86OpCodes ADDRegReg(bool is64Bit) {
  return is64Bit ? ADD8RegReg : ADD4RegReg;
}
inline TR_X86OpCodes ADDRegMem(bool is64Bit) {
  return is64Bit ? ADD8RegMem : ADD4RegMem;
}
inline TR_X86OpCodes LXADDMemReg(bool is64Bit) {
  return is64Bit ? LXADD8MemReg : LXADD4MemReg;
}
inline TR_X86OpCodes ADCMemImm4(bool is64Bit) {
  return is64Bit ? ADC8MemImm4 : ADC4MemImm4;
}
inline TR_X86OpCodes ADCMemReg(bool is64Bit) {
  return is64Bit ? ADC8MemReg : ADC4MemReg;
}
inline TR_X86OpCodes ADCRegReg(bool is64Bit) {
  return is64Bit ? ADC8RegReg : ADC4RegReg;
}
inline TR_X86OpCodes ADCRegMem(bool is64Bit) {
  return is64Bit ? ADC8RegMem : ADC4RegMem;
}
inline TR_X86OpCodes SUBMemImm4(bool is64Bit) {
  return is64Bit ? SUB8MemImm4 : SUB4MemImm4;
}
inline TR_X86OpCodes SUBRegImm4(bool is64Bit) {
  return is64Bit ? SUB8RegImm4 : SUB4RegImm4;
}
inline TR_X86OpCodes SUBMemReg(bool is64Bit) {
  return is64Bit ? SUB8MemReg : SUB4MemReg;
}
inline TR_X86OpCodes SUBRegReg(bool is64Bit) {
  return is64Bit ? SUB8RegReg : SUB4RegReg;
}
inline TR_X86OpCodes SUBRegMem(bool is64Bit) {
  return is64Bit ? SUB8RegMem : SUB4RegMem;
}
inline TR_X86OpCodes SBBMemImm4(bool is64Bit) {
  return is64Bit ? SBB8MemImm4 : SBB4MemImm4;
}
inline TR_X86OpCodes SBBRegImm4(bool is64Bit) {
  return is64Bit ? SBB8RegImm4 : SBB4RegImm4;
}
inline TR_X86OpCodes SBBMemReg(bool is64Bit) {
  return is64Bit ? SBB8MemReg : SBB4MemReg;
}
inline TR_X86OpCodes SBBRegReg(bool is64Bit) {
  return is64Bit ? SBB8RegReg : SBB4RegReg;
}
inline TR_X86OpCodes SBBRegMem(bool is64Bit) {
  return is64Bit ? SBB8RegMem : SBB4RegMem;
}
inline TR_X86OpCodes ORRegImm4(bool is64Bit) {
  return is64Bit ? OR8RegImm4 : OR4RegImm4;
}
inline TR_X86OpCodes ORRegImms(bool is64Bit) {
  return is64Bit ? OR8RegImms : OR4RegImms;
}
inline TR_X86OpCodes ORRegMem(bool is64Bit) {
  return is64Bit ? OR8RegMem : OR4RegMem;
}
inline TR_X86OpCodes XORRegMem(bool is64Bit) {
  return is64Bit ? XOR8RegMem : XOR4RegMem;
}
inline TR_X86OpCodes XORRegImms(bool is64Bit) {
  return is64Bit ? XOR8RegImms : XOR4RegImms;
}
inline TR_X86OpCodes XORRegImm4(bool is64Bit) {
  return is64Bit ? XOR8RegImm4 : XOR4RegImm4;
}
inline TR_X86OpCodes CXXAcc(bool is64Bit) { return is64Bit ? CQOAcc : CDQAcc; }
inline TR_X86OpCodes ANDRegImm4(bool is64Bit) {
  return is64Bit ? AND8RegImm4 : AND4RegImm4;
}
inline TR_X86OpCodes ANDRegReg(bool is64Bit) {
  return is64Bit ? AND8RegReg : AND4RegReg;
}
inline TR_X86OpCodes ANDRegImms(bool is64Bit) {
  return is64Bit ? AND8RegImms : AND4RegImms;
}
inline TR_X86OpCodes ORRegReg(bool is64Bit) {
  return is64Bit ? OR8RegReg : OR4RegReg;
}
inline TR_X86OpCodes MOVRegImm4(bool is64Bit) {
  return is64Bit ? MOV8RegImm4 : MOV4RegImm4;
}
inline TR_X86OpCodes IMULAccReg(bool is64Bit) {
  return is64Bit ? IMUL8AccReg : IMUL4AccReg;
}
inline TR_X86OpCodes IDIVAccMem(bool is64Bit) {
  return is64Bit ? IDIV8AccMem : IDIV4AccMem;
}
inline TR_X86OpCodes IDIVAccReg(bool is64Bit) {
  return is64Bit ? IDIV8AccReg : IDIV4AccReg;
}
inline TR_X86OpCodes DIVAccMem(bool is64Bit) {
  return is64Bit ? DIV8AccMem : DIV4AccMem;
}
inline TR_X86OpCodes DIVAccReg(bool is64Bit) {
  return is64Bit ? DIV8AccReg : DIV4AccReg;
}
inline TR_X86OpCodes NOTReg(bool is64Bit) {
  return is64Bit ? NOT8Reg : NOT4Reg;
}
inline TR_X86OpCodes POPCNTRegReg(bool is64Bit) {
  return is64Bit ? POPCNT8RegReg : POPCNT4RegReg;
}
inline TR_X86OpCodes ROLRegImm1(bool is64Bit) {
  return is64Bit ? ROL8RegImm1 : ROL4RegImm1;
}
inline TR_X86OpCodes ROLRegCL(bool is64Bit) {
  return is64Bit ? ROL8RegCL : ROL4RegCL;
}
inline TR_X86OpCodes SHLMemImm1(bool is64Bit) {
  return is64Bit ? SHL8MemImm1 : SHL4MemImm1;
}
inline TR_X86OpCodes SHLMemCL(bool is64Bit) {
  return is64Bit ? SHL8MemCL : SHL4MemCL;
}
inline TR_X86OpCodes SHLRegImm1(bool is64Bit) {
  return is64Bit ? SHL8RegImm1 : SHL4RegImm1;
}
inline TR_X86OpCodes SHLRegCL(bool is64Bit) {
  return is64Bit ? SHL8RegCL : SHL4RegCL;
}
inline TR_X86OpCodes SARMemImm1(bool is64Bit) {
  return is64Bit ? SAR8MemImm1 : SAR4MemImm1;
}
inline TR_X86OpCodes SARMemCL(bool is64Bit) {
  return is64Bit ? SAR8MemCL : SAR4MemCL;
}
inline TR_X86OpCodes SARRegImm1(bool is64Bit) {
  return is64Bit ? SAR8RegImm1 : SAR4RegImm1;
}
inline TR_X86OpCodes SARRegCL(bool is64Bit) {
  return is64Bit ? SAR8RegCL : SAR4RegCL;
}
inline TR_X86OpCodes SHRMemImm1(bool is64Bit) {
  return is64Bit ? SHR8MemImm1 : SHR4MemImm1;
}
inline TR_X86OpCodes SHRMemCL(bool is64Bit) {
  return is64Bit ? SHR8MemCL : SHR4MemCL;
}
inline TR_X86OpCodes SHRRegImm1(bool is64Bit) {
  return is64Bit ? SHR8RegImm1 : SHR4RegImm1;
}
inline TR_X86OpCodes SHRRegCL(bool is64Bit) {
  return is64Bit ? SHR8RegCL : SHR4RegCL;
}
inline TR_X86OpCodes TESTMemImm4(bool is64Bit) {
  return is64Bit ? TEST8MemImm4 : TEST4MemImm4;
}
inline TR_X86OpCodes TESTRegImm4(bool is64Bit) {
  return is64Bit ? TEST8RegImm4 : TEST4RegImm4;
}
inline TR_X86OpCodes TESTRegReg(bool is64Bit) {
  return is64Bit ? TEST8RegReg : TEST4RegReg;
}
inline TR_X86OpCodes TESTMemReg(bool is64Bit) {
  return is64Bit ? TEST8MemReg : TEST4MemReg;
}
inline TR_X86OpCodes XORRegReg(bool is64Bit) {
  return is64Bit ? XOR8RegReg : XOR4RegReg;
}
inline TR_X86OpCodes CMPRegReg(bool is64Bit) {
  return is64Bit ? CMP8RegReg : CMP4RegReg;
}
inline TR_X86OpCodes CMPRegMem(bool is64Bit) {
  return is64Bit ? CMP8RegMem : CMP4RegMem;
}
inline TR_X86OpCodes CMPMemReg(bool is64Bit) {
  return is64Bit ? CMP8MemReg : CMP4MemReg;
}
inline TR_X86OpCodes CMPXCHGMemReg(bool is64Bit) {
  return is64Bit ? CMPXCHG8MemReg : CMPXCHG4MemReg;
}
inline TR_X86OpCodes LCMPXCHGMemReg(bool is64Bit) {
  return is64Bit ? LCMPXCHG8MemReg : LCMPXCHG4MemReg;
}
inline TR_X86OpCodes REPSTOS(bool is64Bit) {
  return is64Bit ? REPSTOSQ : REPSTOSD;
}
// Floating-point
inline TR_X86OpCodes MOVSMemReg(bool is64Bit) {
  return is64Bit ? MOVSDMemReg : MOVSSMemReg;
}
inline TR_X86OpCodes MOVSRegMem(bool is64Bit) {
  return is64Bit ? MOVSDRegMem : MOVSSRegMem;
}
...
public:
  ...
  uint32_t hasByteImmediate() {
    return _properties[_opCode] & IA32OpProp_ByteImmediate;
  }

  uint32_t hasShortImmediate() {
    return _properties[_opCode] & IA32OpProp_ShortImmediate;
  }

  uint32_t hasIntImmediate() {
    return _properties[_opCode] & IA32OpProp_IntImmediate;
  }

  uint32_t hasLongImmediate() {
    return _properties2[_opCode] & IA32OpProp2_LongImmediate;
  }

  uint32_t hasSignExtendImmediate() {
    return _properties[_opCode] & IA32OpProp_SignExtendImmediate;
  }

  uint32_t testsZeroFlag() {
    return _properties[_opCode] & IA32OpProp_TestsZeroFlag;
  }
  uint32_t modifiesZeroFlag() {
    return _properties[_opCode] & IA32OpProp_ModifiesZeroFlag;
  }
  uint32_t referencesZeroFlag() {
    return _properties[_opCode] &
           (IA32OpProp_ModifiesZeroFlag | IA32OpProp_TestsZeroFlag);
  }

  uint32_t testsSignFlag() {
    return _properties[_opCode] & IA32OpProp_TestsSignFlag;
  }
  uint32_t modifiesSignFlag() {
    return _properties[_opCode] & IA32OpProp_ModifiesSignFlag;
  }
  uint32_t referencesSignFlag() {
    return _properties[_opCode] &
           (IA32OpProp_ModifiesSignFlag | IA32OpProp_TestsSignFlag);
  }

  uint32_t testsCarryFlag() {
    return _properties[_opCode] & IA32OpProp_TestsCarryFlag;
  }
  uint32_t modifiesCarryFlag() {
    return _properties[_opCode] & IA32OpProp_ModifiesCarryFlag;
  }
  uint32_t referencesCarryFlag() {
    return _properties[_opCode] &
           (IA32OpProp_ModifiesCarryFlag | IA32OpProp_TestsCarryFlag);
  }

  uint32_t testsOverflowFlag() {
    return _properties[_opCode] & IA32OpProp_TestsOverflowFlag;
  }
  uint32_t modifiesOverflowFlag() {
    return _properties[_opCode] & IA32OpProp_ModifiesOverflowFlag;
  }
  uint32_t referencesOverflowFlag() {
    return _properties[_opCode] &
           (IA32OpProp_ModifiesOverflowFlag | IA32OpProp_TestsOverflowFlag);
  }

  uint32_t testsParityFlag() {
    return _properties[_opCode] & IA32OpProp_TestsParityFlag;
  }
  uint32_t modifiesParityFlag() {
    return _properties[_opCode] & IA32OpProp_ModifiesParityFlag;
  }
  uint32_t referencesParityFlag() {
    return _properties[_opCode] &
           (IA32OpProp_ModifiesParityFlag | IA32OpProp_TestsParityFlag);
  }

  uint32_t hasByteSource() {
    return _properties[_opCode] & IA32OpProp_ByteSource;
  }

  uint32_t hasByteTarget() {
    return _properties[_opCode] & IA32OpProp_ByteTarget;
  }

  uint32_t hasShortSource() {
    return _properties[_opCode] & IA32OpProp_ShortSource;
  }

  uint32_t hasShortTarget() {
    return _properties[_opCode] & IA32OpProp_ShortTarget;
  }

  uint32_t hasIntSource() {
    return _properties[_opCode] & IA32OpProp_IntSource;
  }

  uint32_t hasIntTarget() {
    return _properties[_opCode] & IA32OpProp_IntTarget;
  }

  uint32_t hasLongSource() {
    return _properties2[_opCode] & IA32OpProp2_LongSource;
  }

  uint32_t hasLongTarget() {
    return _properties2[_opCode] & IA32OpProp2_LongTarget;
  }

  uint32_t hasDoubleWordSource() {
    return _properties2[_opCode] & IA32OpProp2_DoubleWordSource;
  }

  uint32_t hasDoubleWordTarget() {
    return _properties2[_opCode] & IA32OpProp2_DoubleWordTarget;
  }

  uint32_t hasXMMSource() {
    return _properties2[_opCode] & IA32OpProp2_XMMSource;
  }

  uint32_t hasXMMTarget() {
    return _properties2[_opCode] & IA32OpProp2_XMMTarget;
  }

  uint32_t isPseudoOp() { return _properties2[_opCode] & IA32OpProp2_PseudoOp; }

  // Temporarily disable broken logic so that the proper instructions appear in
  // JIT logs
  uint32_t cannotBeAssembled() {
    return false;
  } // {return _properties2[_opCode] & IA32OpProp2_CannotBeAssembled;}
  ...
  uint32_t needs16BitOperandPrefix() {
    return _properties[_opCode] & IA32OpProp_Needs16BitOperandPrefix;
  }

  uint32_t needs64BitOperandPrefix() {
    return _properties2[_opCode] & IA32OpProp2_Needs64BitOperandPrefix;
  }

  uint32_t needsScalarPrefix() {
    return _properties2[_opCode] & IA32OpProp2_NeedsScalarPrefix;
  }

  uint32_t needsRepPrefix() {
    return _properties2[_opCode] & IA32OpProp2_NeedsRepPrefix;
  }

  uint32_t needsLockPrefix() {
    return _properties2[_opCode] & IA32OpProp2_NeedsLockPrefix;
  }

  uint32_t needsXacquirePrefix() {
    return _properties2[_opCode] & IA32OpProp2_NeedsXacquirePrefix;
  }

  uint32_t needsXreleasePrefix() {
    return _properties2[_opCode] & IA32OpProp2_NeedsXreleasePrefix;
  }

  uint32_t needsSSE42OpcodePrefix() {
    return _properties2[_opCode] & IA32OpProp2_NeedsSSE42OpcodePrefix;
  }
  ...
  uint32_t hasRelativeBranchDisplacement() {
    return isBranchOp() || isCallImmOp();
  }

  uint32_t isShortBranchOp() { return isBranchOp() && hasByteImmediate(); }

  uint32_t testsSomeFlag() {
    return _properties[_opCode] & IA32OpProp_TestsSomeFlag;
  }

  uint32_t modifiesSomeArithmeticFlags() {
    return _properties[_opCode] & IA32OpProp_SetsSomeArithmeticFlag;
  }
  bool modifiesAllArithmeticFlags() {
    return (_properties[_opCode] & IA32OpProp_SetsSomeArithmeticFlag) ==
           IA32OpProp_SetsSomeArithmeticFlag;
  }

  uint32_t setsCCForCompare() {
    return _properties2[_opCode] & IA32OpProp2_SetsCCForCompare;
  }
  uint32_t setsCCForTest() {
    return _properties2[_opCode] & IA32OpProp2_SetsCCForTest;
  }
  ...
  uint32_t supportsLockPrefix() {
    return _properties2[_opCode] & IA32OpProp2_SupportsLockPrefix;
  }

  bool isConditionalBranchOp() { return isBranchOp() && testsSomeFlag(); }

  uint32_t hasPopInstruction() {
    return _properties[_opCode] & IA32OpProp_HasPopInstruction;
  }

  uint32_t isPopInstruction() {
    return _properties[_opCode] & IA32OpProp_IsPopInstruction;
  }

  uint32_t sourceOpTarget() {
    return _properties[_opCode] & IA32OpProp_SourceOpTarget;
  }

  uint32_t hasDirectionBit() {
    return _properties[_opCode] & IA32OpProp_HasDirectionBit;
  }

  uint32_t isAMD64DeprecatedDec() {
    return _properties2[_opCode] & IA32OpProp2_IsAMD64DeprecatedDec;
  }

  uint32_t isAMD64DeprecatedInc() {
    return _properties2[_opCode] & IA32OpProp2_IsAMD64DeprecatedInc;
  }

  uint32_t isIA32Only() {
    return _properties2[_opCode] & IA32OpProp2_IsIA32Only;
  }

  uint32_t sourceIsMemRef() {
    return _properties2[_opCode] & IA32OpProp2_SourceIsMemRef;
  }

  uint32_t targetRegIsImplicit() {
    return _properties2[_opCode] & IA32OpProp2_TargetRegIsImplicit;
  }
  uint32_t sourceRegIsImplicit() {
    return _properties2[_opCode] & IA32OpProp2_SourceRegIsImplicit;
  }

  uint32_t isFusableCompare() {
    return _properties2[_opCode] & IA32OpProp2_FusableCompare;
  }

  bool isSetRegInstruction() {
    return !(((*(uint32_t *)&_binaryEncodings[_opCode]) & 0x00fff0ff) ^
             0x00c0900f);
  }

  uint8_t *copyBinaryToBuffer(uint8_t *cursor) {
    return copyBinaryToBuffer(_opCode, cursor);
  }
  ...
  static uint32_t modifiesTarget(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ModifiesTarget;
  }

  static uint32_t modifiesSource(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ModifiesSource;
  }

  static uint32_t usesTarget(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_UsesTarget;
  }

  static uint32_t singleFPOp(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_SingleFP;
  }

  static uint32_t doubleFPOp(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_DoubleFP;
  }

  static uint32_t gprOp(TR_X86OpCodes op) {
    return (_properties[op] & (IA32OpProp_DoubleFP | IA32OpProp_SingleFP)) == 0;
  }

  static uint32_t fprOp(TR_X86OpCodes op) {
    return (_properties[op] & (IA32OpProp_DoubleFP | IA32OpProp_SingleFP));
  }

  static uint32_t hasByteImmediate(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ByteImmediate;
  }

  static uint32_t hasShortImmediate(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ShortImmediate;
  }

  static uint32_t hasIntImmediate(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_IntImmediate;
  }

  static uint32_t hasLongImmediate(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_LongImmediate;
  }

  static uint32_t hasSignExtendImmediate(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_SignExtendImmediate;
  }

  static uint32_t testsZeroFlag(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_TestsZeroFlag;
  }
  static uint32_t modifiesZeroFlag(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ModifiesZeroFlag;
  }
  static uint32_t referencesZeroFlag(TR_X86OpCodes op) {
    return _properties[op] &
           (IA32OpProp_ModifiesZeroFlag | IA32OpProp_TestsZeroFlag);
  }

  static uint32_t testsSignFlag(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_TestsSignFlag;
  }
  static uint32_t modifiesSignFlag(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ModifiesSignFlag;
  }
  static uint32_t referencesSignFlag(TR_X86OpCodes op) {
    return _properties[op] &
           (IA32OpProp_ModifiesSignFlag | IA32OpProp_TestsSignFlag);
  }

  static uint32_t testsCarryFlag(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_TestsCarryFlag;
  }
  static uint32_t modifiesCarryFlag(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ModifiesCarryFlag;
  }
  static uint32_t referencesCarryFlag(TR_X86OpCodes op) {
    return _properties[op] &
           (IA32OpProp_ModifiesCarryFlag | IA32OpProp_TestsCarryFlag);
  }

  static uint32_t testsOverflowFlag(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_TestsOverflowFlag;
  }
  static uint32_t modifiesOverflowFlag(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ModifiesOverflowFlag;
  }
  static uint32_t referencesOverflowFlag(TR_X86OpCodes op) {
    return _properties[op] &
           (IA32OpProp_ModifiesOverflowFlag | IA32OpProp_TestsOverflowFlag);
  }

  static uint32_t testsParityFlag(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_TestsParityFlag;
  }
  static uint32_t modifiesParityFlag(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ModifiesParityFlag;
  }
  static uint32_t referencesParityFlag(TR_X86OpCodes op) {
    return _properties[op] &
           (IA32OpProp_ModifiesParityFlag | IA32OpProp_TestsParityFlag);
  }

  static uint32_t hasByteSource(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ByteSource;
  }

  static uint32_t hasByteTarget(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ByteTarget;
  }

  static uint32_t hasShortSource(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ShortSource;
  }

  static uint32_t hasShortTarget(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_ShortTarget;
  }

  static uint32_t hasIntSource(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_IntSource;
  }

  static uint32_t hasIntTarget(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_IntTarget;
  }

  static uint32_t hasLongSource(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_LongSource;
  }

  static uint32_t hasLongTarget(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_LongTarget;
  }

  static uint32_t hasDoubleWordSource(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_DoubleWordSource;
  }

  static uint32_t hasDoubleWordTarget(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_DoubleWordTarget;
  }

  static uint32_t hasXMMSource(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_XMMSource;
  }

  static uint32_t hasXMMTarget(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_XMMTarget;
  }

  static uint32_t isPseudoOp(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_PseudoOp;
  }
...
//
...
#else
    TR_ASSERT(!(_properties2[op] & IA32OpProp2_Needs64BitOperandPrefix),
              "Don't use 64-bit opcodes on 32-bit targets");
    return 0;
#endif
  }

  static uint32_t needs16BitOperandPrefix(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_Needs16BitOperandPrefix;
  }

  static uint32_t needsScalarPrefix(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_NeedsScalarPrefix;
  }

  static uint32_t needsRepPrefix(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_NeedsRepPrefix;
  }

  static uint32_t hasTargetRegisterInOpcode(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_TargetRegisterInOpcode;
  }

  static uint32_t hasTargetRegisterInModRM(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_TargetRegisterInModRM;
  }

  static uint32_t hasTargetRegisterIgnored(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_TargetRegisterIgnored;
  }

  static uint32_t hasSourceRegisterInModRM(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_SourceRegisterInModRM;
  }

  static uint32_t hasSourceRegisterIgnored(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_SourceRegisterIgnored;
  }

  static uint32_t isBranchOp(TR_X86OpCodes op) {
    return _properties[op] & IA32OpProp_BranchOp;
  }
  static uint32_t hasRelativeBranchDisplacement(TR_X86OpCodes op) {
    return isBranchOp(op) || isCallImmOp(op);
  }

  static uint32_t setsCCForCompare(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_SetsCCForCompare;
  }
  static uint32_t setsCCForTest(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_SetsCCForTest;
  }
  static uint32_t isShiftOp(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_ShiftOp;
  }
  static uint32_t isRotateOp(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_RotateOp;
  }
  static uint32_t isPushOp(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_PushOp;
  }
  static uint32_t isPopOp(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_PopOp;
  }
  static uint32_t isCallOp(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_CallOp;
  }
  static uint32_t isCallImmOp(TR_X86OpCodes op) {
    return op == CALLImm4 || op == CALLREXImm4;
  }

  static uint32_t supportsLockPrefix(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_SupportsLockPrefix;
  }

  static uint32_t targetRegIsImplicit(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_TargetRegIsImplicit;
  }
  static uint32_t sourceRegIsImplicit(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_SourceRegIsImplicit;
  }

  static uint32_t isFusableCompare(TR_X86OpCodes op) {
    return _properties2[op] & IA32OpProp2_FusableCompare;
  }
  ...
  static uint8_t getOpCodeLength(TR_X86OpCodes op) {
    return _binaryEncodings[op]._length;
  }
