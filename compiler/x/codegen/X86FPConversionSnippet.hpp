...
public:
  X86fbits2iSnippet(TR::LabelSymbol *restartlab, TR::LabelSymbol *snippetlab,
                    TR::X86RegImmInstruction *instr, TR::CodeGenerator *codeGen)
      : TR::X86RestartSnippet(codeGen, instr->getNode(), restartlab, snippetlab,
                              false),
        _instruction(instr) {}
...
public:
  ...
  AMD64FPConversionSnippet(TR::LabelSymbol *, TR::LabelSymbol *,
                           TR::SymbolReference *, TR::X86RegInstruction *,
                           TR::CodeGenerator *)
  ...
  TR::X86RegRegInstruction *getConvertInstruction() {
