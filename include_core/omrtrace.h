...
typedef struct OMR_TraceThread {
  ...
  unsigned char currentOutputMask; /* Bitmask containing the options
                                                                    * for the
                                    * tracepoint currently being formatted
                                                                    */
 ...
 *                are used to register the thread. The trace engine's thread
 * identifier will be
 ...
 * operation in any
 * environment where OMR expects the runtime to call fork(). Trace
 * initialization and termination
 * concurrent to fork is not supported; these operations must be done at vm
