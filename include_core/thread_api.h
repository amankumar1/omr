 ...
 * J9THREAD_CATEGORY_SYSTEM_THREAD thread.
 * If a non NULL attr is passed, only the thread category will be used, all
 ...
 * omrthread_monitor structures
 * associated with non-existent threads in the child process. This function is
 ...
 * of the reset code
 * is incomplete: in postForkResetThreads, the omrthread_t->handle must be reset
 * differently.
 *
 ...
 * reset. This function is
 * to be called directly after a fork, before any other omrthread functions, and
