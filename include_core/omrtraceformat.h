 ...
 * though
 * this is not required. Care must be taken that the format file matches the
 * original
 * trace point data as it will contain format specifiers which will be filled in
 * when
 ...
 * @param[in,out] iteratorPtr A pointer to a location where the initialised
 ...
 * a UtTraceFileIterator.
 * If there are no more trace buffers in the file *bufferIteratorPtr will point
 * to NULL.
 *
 ...
 * initialised UtTracePointIterator pointer can be stored.
