...
#include <mach/mach.h>
#endif /* defined(OSX) */
#endif /* (defined(LINUX) || defined(OSX) || defined(MVS) ||                   \
          defined(J9ZOS390)) */
 ...
 * streams
 * where we compile against AIX 5.2, we need to dynamically look up the methods
 * at runtime.
 *
...
#define SEM_INIT(sm, pshrd, inval) (dispatch_semaphore_init((sm), (inval)))
...
#elif defined(OSX)
#define SEM_POST(smP) (dispatch_semaphore_signal((dispatch_semaphore_t)(smP)))
#elif defined(J9ZOS390)
...
#define J9OSCOND_WAIT_TIMED_LOOP()                                             \
  }                                                                            \
  }                                                                            \
  while (0)
