 ...
 * 1 - fillInUTInterfaces - Setup function pointers in interfaces via
 * fillInUTInterfaces
 ...
 * end.
 * [6] - setOptions 	- set any additional default options or process any
 * options specified on the command line.
 * 8 - Initialise port, thread and any other modules that may have loaded before
 * trace was ready.
