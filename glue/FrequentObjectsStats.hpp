...
private:
   ...
   * of the time.
   * Derived from a sample run of Eclipse, which showed that the size necessary
   * to have accurately report the top k
...
public:
   ...
   * allocations (estimated probability of 90% of
   * reporting this accurately (and in the correct order).  The larger k is, the
