 ...
 * @ingroup GC_Base
 */
class MM_ConfigurationLanguageInterfaceImpl
    : public MM_ConfigurationLanguageInterface {
private:
protected:
...
public:
  static MM_ConfigurationLanguageInterfaceImpl *
  ...
  createEnvironmentLanguageInterface(MM_EnvironmentBase *env);
  ...
  void initializeSaltData(MM_EnvironmentBase *env, uintptr_t index,
                          uint32_t startValue);
