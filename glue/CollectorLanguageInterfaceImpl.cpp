...
/* This will likely get moved back into MarkingScheme and use an object scanner
 * to walk the slots of an Object */
...
void MM_CollectorLanguageInterfaceImpl::scavenger_reverseForwardedObject(
  ...
  /* This method must restore the object header slot (and overlapped slot, if
   * header is compressed)
   * in the original object and install a reverse forwarded object in the
   * forwarding location.
   * A reverse forwarded object is a hole (MM_HeapLinkedFreeHeader) whose 'next'
   * pointer actually
   * points at the original object. This keeps tenure space walkable once the
   * reverse forwarded
