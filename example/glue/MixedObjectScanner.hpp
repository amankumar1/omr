...
protected:
   ...
   */
  GC_MixedObjectScanner(MM_EnvironmentStandard *env, omrobjectptr_t objectPtr,
                        uintptr_t flags)
      : GC_ObjectScanner(env, objectPtr, (fomrobject_t *)objectPtr + 1, 0,
                         flags, 0),
        _endPtr(
   ...
   * @param[in] env The scanning thread environment
   */
  void initialize(MM_EnvironmentStandard *env) {
...
public:
  ...
  newInstance(MM_EnvironmentStandard *env, omrobjectptr_t objectPtr,
